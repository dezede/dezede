...
urlpatterns = patterns('',
    ...
    url(r'^sources/(?P<pk>\d+)/$', SourceDetailView.as_view(),
        name='source_pk'),
    url(r'^roles_et_instruments/$', PartieListView.as_view(), name='parties'),
    url(r'^roles_et_instruments/(?P<slug>[\w-]+)/$',
        PartieDetailView.as_view(), name='partie'),
    url(r'^roles_et_instruments/id/(?P<pk>\d+)/$', PartieDetailView.as_view(),
        name='partie_pk'),
