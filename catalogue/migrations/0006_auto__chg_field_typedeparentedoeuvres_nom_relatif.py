...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TypeDeParenteDOeuvres.nom_relatif'
        db.alter_column('catalogue_typedeparentedoeuvres', 'nom_relatif', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'TypeDeParenteDOeuvres.nom_relatif'
        db.alter_column('catalogue_typedeparentedoeuvres', 'nom_relatif', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))
