...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'catalogue_partie', ['nom'])

        # Adding unique constraint on 'Partie', fields ['slug']
        db.create_unique(u'catalogue_partie', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Partie', fields ['slug']
        db.delete_unique(u'catalogue_partie', ['slug'])

        # Removing unique constraint on 'Partie', fields ['nom']
        db.delete_unique(u'catalogue_partie', ['nom'])
