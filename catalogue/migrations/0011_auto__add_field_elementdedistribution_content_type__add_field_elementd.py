...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_elementdedistribution', 'content_type',
        ...
        db.add_column(u'catalogue_elementdedistribution', 'object_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'catalogue_elementdedistribution', 'content_type_id')

        # Deleting field 'ElementDeDistribution.object_id'
        db.delete_column(u'catalogue_elementdedistribution', 'object_id')
