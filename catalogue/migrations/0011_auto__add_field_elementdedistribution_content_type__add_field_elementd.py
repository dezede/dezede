...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'ElementDeDistribution.content_type'
        db.delete_column('catalogue_elementdedistribution', 'content_type_id')

        # Deleting field 'ElementDeDistribution.object_id'
        db.delete_column('catalogue_elementdedistribution', 'object_id')

        # Adding M2M table for field distribution on 'Evenement'
        db.create_table('catalogue_evenement_distribution', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evenement', models.ForeignKey(orm['catalogue.evenement'],
                                            null=False)),
            ('elementdedistribution', models.ForeignKey(orm[
                                                            'catalogue'
                                                            '.elementdedistribution'], null=False))
        ))
    ...
    models = {
        ...
        'catalogue.elementdeprogramme': {
            ...
            'caracteristiques': ('django.db.models.fields.related'
                                 '.ManyToManyField', [], {'blank': 'True', 'related_name': "u'elements_de_programme'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalogue.CaracteristiqueDElementDeProgramme']"}),
        ...
        'catalogue.oeuvre': {
            ...
            'filles': ('django.db.models.fields.related.ManyToManyField',
                       [], {'related_name': "u'meres'", 'symmetrical': 'False', 'through': "orm['catalogue.ParenteDOeuvres']", 'to': "orm['catalogue.Oeuvre']"}),
        ...
        'catalogue.parentedoeuvres': {
            ...
            'mere': ('django.db.models.fields.related.ForeignKey', [],
                     {'related_name': "u'parentes_filles'", 'to': "orm['catalogue.Oeuvre']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'catalogue.source': {
            ...
            'evenements': ('django.db.models.fields.related.ManyToManyField'
                           '', [], {'blank': 'True', 'related_name': "u'sources'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalogue.Evenement']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'illustrations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['catalogue.Illustration']", 'null': 'True', 'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'notes': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'numero': ('django.db.models.fields.CharField', [], {'max_length'
                                                                 '': '50',
                                                                 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
