...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NatureDeLieu.referent'
        db.add_column('catalogue_naturedelieu', 'referent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NatureDeLieu.referent'
        db.delete_column('catalogue_naturedelieu', 'referent')
