...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TypeDeParenteDOeuvres.nom_relatif'
        db.add_column('catalogue_typedeparentedoeuvres', 'nom_relatif',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True),
                      keep_default=False)

        # Adding field 'TypeDeParenteDOeuvres.nom_relatif_pluriel'
        db.add_column('catalogue_typedeparentedoeuvres', 'nom_relatif_pluriel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=130, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TypeDeParenteDOeuvres.nom_relatif'
        db.delete_column('catalogue_typedeparentedoeuvres', 'nom_relatif')

        # Deleting field 'TypeDeParenteDOeuvres.nom_relatif_pluriel'
        db.delete_column('catalogue_typedeparentedoeuvres', 'nom_relatif_pluriel')
    ...
    models = {
        ...
        'catalogue.typedeparentedoeuvres': {
            ...
            'nom_relatif': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True'}),
