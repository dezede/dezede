...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Individu', fields ['slug']
        db.create_unique('catalogue_individu', ['slug'])

        # Adding unique constraint on 'Oeuvre', fields ['slug']
        db.create_unique('catalogue_oeuvre', ['slug'])

        # Adding unique constraint on 'Lieu', fields ['slug']
        db.create_unique('catalogue_lieu', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Lieu', fields ['slug']
        db.delete_unique('catalogue_lieu', ['slug'])

        # Removing unique constraint on 'Oeuvre', fields ['slug']
        db.delete_unique('catalogue_oeuvre', ['slug'])

        # Removing unique constraint on 'Individu', fields ['slug']
        db.delete_unique('catalogue_individu', ['slug'])
    ...
    models = {
        ...
        'catalogue.lieu': {
            ...
            'notes': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['catalogue.Lieu']", 'null': 'True', 'blank': 'True'}),
