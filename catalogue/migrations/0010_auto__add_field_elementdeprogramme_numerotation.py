...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_elementdeprogramme', 'numerotation',
                      self.gf('django.db.models.fields.CharField')(default=u'O', max_length=1),
                      keep_default=False)

        # Adding M2M table for field distribution on 'Evenement'
        db.create_table(u'catalogue_evenement_distribution', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evenement', models.ForeignKey(orm[u'catalogue.evenement'], null=False)),
            ('elementdedistribution', models.ForeignKey(orm[u'catalogue.elementdedistribution'], null=False))
        ))
        db.create_unique(u'catalogue_evenement_distribution', ['evenement_id', 'elementdedistribution_id'])


    def backwards(self, orm):
        # Deleting field 'ElementDeProgramme.numerotation'
        db.delete_column(u'catalogue_elementdeprogramme', 'numerotation')
    ...
    models = {
        ...
        u'catalogue.elementdedistribution': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'pupitre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'elements_de_distribution'", 'to': u"orm['catalogue.Pupitre']"})
        },
        ...
        u'catalogue.evenement': {
            ...
            'distribution': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'evenements'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalogue.ElementDeDistribution']"}),
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['catalogue.Document']", 'null': 'True', 'blank': 'True'}),
            'etat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Etat']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'illustrations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['catalogue.Illustration']", 'null': 'True', 'blank': 'True'}),
