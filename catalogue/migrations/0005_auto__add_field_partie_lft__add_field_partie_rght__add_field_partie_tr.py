...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_partie', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Partie.rght'
        db.add_column(u'catalogue_partie', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Partie.tree_id'
        db.add_column(u'catalogue_partie', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Partie.level'
        db.add_column(u'catalogue_partie', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Partie.parente'
        db.alter_column(u'catalogue_partie', 'parente_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['catalogue.Partie']))

    def backwards(self, orm):
        # Deleting field 'Partie.lft'
        db.delete_column(u'catalogue_partie', 'lft')

        # Deleting field 'Partie.rght'
        db.delete_column(u'catalogue_partie', 'rght')

        # Deleting field 'Partie.tree_id'
        db.delete_column(u'catalogue_partie', 'tree_id')

        # Deleting field 'Partie.level'
        db.delete_column(u'catalogue_partie', 'level')


        # Changing field 'Partie.parente'
        db.alter_column(u'catalogue_partie', 'parente_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Partie']))
    ...
    models = {
        ...
        u'catalogue.partie': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': u"orm['catalogue.Partie']"}),
