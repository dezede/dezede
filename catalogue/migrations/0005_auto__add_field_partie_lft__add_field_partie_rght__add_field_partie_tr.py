...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catalogue_partie', 'lft')

        # Deleting field 'Partie.rght'
        db.delete_column('catalogue_partie', 'rght')

        # Deleting field 'Partie.tree_id'
        db.delete_column('catalogue_partie', 'tree_id')

        # Deleting field 'Partie.level'
        db.delete_column('catalogue_partie', 'level')


        # Changing field 'Partie.parente'
        db.alter_column('catalogue_partie', 'parente_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Partie']))
    ...
    models = {
        ...
        'catalogue.partie': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': "orm['catalogue.Partie']"}),
