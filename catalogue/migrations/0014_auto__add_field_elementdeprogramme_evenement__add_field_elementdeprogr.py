...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElementDeProgramme.evenement'
        db.add_column('catalogue_elementdeprogramme', 'evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Evenement'], null=True),
                      keep_default=False)

        # Adding field 'ElementDeProgramme.position'
        db.add_column('catalogue_elementdeprogramme', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElementDeProgramme.evenement'
        db.delete_column('catalogue_elementdeprogramme', 'evenement_id')

        # Deleting field 'ElementDeProgramme.position'
        db.delete_column('catalogue_elementdeprogramme', 'position')
    ...
    models = {
        ...
        'catalogue.elementdeprogramme': {
            ...
            'evenement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Evenement']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
