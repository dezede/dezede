...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_lieu', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['catalogue.Lieu']))

    def backwards(self, orm):

        # Changing field 'Lieu.parent'
        db.alter_column('catalogue_lieu', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Lieu']))
    ...
    models = {
        ...
        'catalogue.lieu': {
            ...
            'notes': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'enfants'", 'null': 'True', 'to': "orm['catalogue.Lieu']"}),
