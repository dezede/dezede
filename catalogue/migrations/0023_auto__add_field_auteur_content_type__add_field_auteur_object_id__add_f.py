...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auteur.content_type'
        db.add_column('catalogue_auteur', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Auteur.object_id'
        db.add_column('catalogue_auteur', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Auteur.individu'
        db.add_column('catalogue_auteur', 'individu',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Individu'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auteur.content_type'
        db.delete_column('catalogue_auteur', 'content_type_id')

        # Deleting field 'Auteur.object_id'
        db.delete_column('catalogue_auteur', 'object_id')

        # Deleting field 'Auteur.individu'
        db.delete_column('catalogue_auteur', 'individu_id')
    ...
    models = {
        ...
        'catalogue.auteur': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Individu']", 'null': 'True'}),
