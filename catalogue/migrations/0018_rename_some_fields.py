...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'AttributionDePupitre.author'
        db.rename_column('catalogue_attributiondepupitre', 'author_id', 'owner_id')

        # Renaming field 'ParenteDIndividus.author'
        db.rename_column('catalogue_parentedindividus', 'author_id', 'owner_id')

        # Renaming field 'TypeDeSource.author'
        db.rename_column('catalogue_typedesource', 'author_id', 'owner_id')

        # Renaming field 'Document.author'
        db.rename_column('catalogue_document', 'author_id', 'owner_id')

        # Renaming field 'TypeDePersonnel.author'
        db.rename_column('catalogue_typedepersonnel', 'author_id', 'owner_id')

        # Renaming field 'Profession.author'
        db.rename_column('catalogue_profession', 'author_id', 'owner_id')

        # Renaming field 'Saison.author'
        db.rename_column('catalogue_saison', 'author_id', 'owner_id')

        # Renaming field 'CaracteristiqueDOeuvre.author'
        db.rename_column('catalogue_caracteristiquedoeuvre', 'author_id', 'owner_id')

        # Renaming field 'NatureDeLieu.author'
        db.rename_column('catalogue_naturedelieu', 'author_id', 'owner_id')

        # Renaming field 'Prenom.author'
        db.rename_column('catalogue_prenom', 'author_id', 'owner_id')

        # Renaming field 'Pupitre.author'
        db.rename_column('catalogue_pupitre', 'author_id', 'owner_id')

        # Renaming field 'ElementDeProgramme.author'
        db.rename_column('catalogue_elementdeprogramme', 'author_id', 'owner_id')

        # Renaming field 'TypeDeParenteDOeuvres.author'
        db.rename_column('catalogue_typedeparentedoeuvres', 'author_id', 'owner_id')

        # Renaming field 'Partie.author'
        db.rename_column('catalogue_partie', 'author_id', 'owner_id')

        # Renaming field 'Source.author'
        db.rename_column('catalogue_source', 'author_id', 'owner_id')

        # Renaming field 'Devise.author'
        db.rename_column('catalogue_devise', 'author_id', 'owner_id')

        # Renaming field 'TypeDeCaracteristiqueDOeuvre.author'
        db.rename_column('catalogue_typedecaracteristiquedoeuvre', 'author_id', 'owner_id')

        # Renaming field 'Personnel.author'
        db.rename_column('catalogue_personnel', 'author_id', 'owner_id')

        # Renaming field 'CaracteristiqueDElementDeProgramme.author'
        db.rename_column('catalogue_caracteristiquedelementdeprogramme', 'author_id', 'owner_id')

        # Renaming field 'Individu.author'
        db.rename_column('catalogue_individu', 'author_id', 'owner_id')

        # Renaming field 'Engagement.author'
        db.rename_column('catalogue_engagement', 'author_id', 'owner_id')

        # Renaming field 'Oeuvre.author'
        db.rename_column('catalogue_oeuvre', 'author_id', 'owner_id')

        # Renaming field 'Lieu.author'
        db.rename_column('catalogue_lieu', 'author_id', 'owner_id')

        # Renaming field 'GenreDOeuvre.author'
        db.rename_column('catalogue_genredoeuvre', 'author_id', 'owner_id')

        # Renaming field 'TypeDeParenteDIndividus.author'
        db.rename_column('catalogue_typedeparentedindividus', 'author_id', 'owner_id')

        # Renaming field 'Etat.author'
        db.rename_column('catalogue_etat', 'author_id', 'owner_id')

        # Renaming field 'Etat.publie'
        db.rename_column('catalogue_etat', 'publie', 'public')

        # Renaming field 'Evenement.author'
        db.rename_column('catalogue_evenement', 'author_id', 'owner_id')

        # Renaming field 'Illustration.author'
        db.rename_column('catalogue_illustration', 'author_id', 'owner_id')

        # Renaming field 'Auteur.author'
        db.rename_column('catalogue_auteur', 'author_id', 'owner_id')

        # Renaming field 'AncrageSpatioTemporel.author'
        db.rename_column('catalogue_ancragespatiotemporel', 'author_id', 'owner_id')

        # Renaming field 'ParenteDOeuvres.author'
        db.rename_column('catalogue_parentedoeuvres', 'author_id', 'owner_id')
    ...
    models = {
        ...
        'catalogue.auteur': {
            'Meta': {'ordering': "['profession', 'individus__nom']", 'object_name': 'Auteur'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
