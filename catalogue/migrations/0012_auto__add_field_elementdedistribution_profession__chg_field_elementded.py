...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_elementdedistribution', 'profession',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'elements_de_distribution', null=True, to=orm['catalogue.Profession']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ElementDeDistribution.profession'
        db.delete_column(u'catalogue_elementdedistribution', 'profession_id')


        # User chose to not deal with backwards NULL issues for 'ElementDeDistribution.pupitre'
        raise RuntimeError("Cannot reverse this migration. 'ElementDeDistribution.pupitre' and its values cannot be restored.")
