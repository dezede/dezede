...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lieu.lft'
        db.add_column('catalogue_lieu', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Lieu.rght'
        db.add_column('catalogue_lieu', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Lieu.tree_id'
        db.add_column('catalogue_lieu', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Lieu.level'
        db.add_column('catalogue_lieu', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lieu.lft'
        db.delete_column('catalogue_lieu', 'lft')

        # Deleting field 'Lieu.rght'
        db.delete_column('catalogue_lieu', 'rght')

        # Deleting field 'Lieu.tree_id'
        db.delete_column('catalogue_lieu', 'tree_id')

        # Deleting field 'Lieu.level'
        db.delete_column('catalogue_lieu', 'level')
