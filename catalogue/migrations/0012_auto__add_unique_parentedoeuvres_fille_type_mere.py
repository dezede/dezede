...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ParenteDOeuvres', fields ['fille', 'type', 'mere']
        db.create_unique('catalogue_parentedoeuvres', ['fille_id', 'type_id', 'mere_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ParenteDOeuvres', fields ['fille', 'type', 'mere']
        db.delete_unique('catalogue_parentedoeuvres', ['fille_id', 'type_id', 'mere_id'])
