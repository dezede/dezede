...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_auteur', 'individu_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Individu']))

        # Changing field 'Auteur.object_id'
        db.alter_column('catalogue_auteur', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))

        # Changing field 'Auteur.content_type'
        db.alter_column('catalogue_auteur', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Auteur.individu'
        db.alter_column('catalogue_auteur', 'individu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Individu'], null=True))

        # Changing field 'Auteur.object_id'
        db.alter_column('catalogue_auteur', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Auteur.content_type'
        db.alter_column('catalogue_auteur', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))
    ...
    models = {
        ...
        'catalogue.auteur': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Individu']"}),
