...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_oeuvre', 'contenu_dans',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name=u'enfants', null=True, to=orm['catalogue.Oeuvre']),
                      keep_default=False)

        # Adding field 'Oeuvre.lft'
        db.add_column(u'catalogue_oeuvre', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Oeuvre.rght'
        db.add_column(u'catalogue_oeuvre', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Oeuvre.tree_id'
        db.add_column(u'catalogue_oeuvre', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Oeuvre.level'
        db.add_column(u'catalogue_oeuvre', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'GenreDOeuvre.referent'
        db.add_column(u'catalogue_genredoeuvre', 'referent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oeuvre.contenu_dans'
        db.delete_column(u'catalogue_oeuvre', 'contenu_dans_id')

        # Deleting field 'Oeuvre.lft'
        db.delete_column(u'catalogue_oeuvre', 'lft')

        # Deleting field 'Oeuvre.rght'
        db.delete_column(u'catalogue_oeuvre', 'rght')

        # Deleting field 'Oeuvre.tree_id'
        db.delete_column(u'catalogue_oeuvre', 'tree_id')

        # Deleting field 'Oeuvre.level'
        db.delete_column(u'catalogue_oeuvre', 'level')

        # Deleting field 'GenreDOeuvre.referent'
        db.delete_column(u'catalogue_genredoeuvre', 'referent')
    ...
    models = {
        ...
        u'catalogue.attributiondepupitre': {
            'Meta': {'ordering': "[u'pupitre']", 'object_name': 'AttributionDePupitre'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individus': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'attributions_de_pupitre'", 'symmetrical': 'False', 'to': u"orm['catalogue.Individu']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'pupitre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'attributions_de_pupitre'", 'to': u"orm['catalogue.Pupitre']"})
        },
        u'catalogue.auteur': {
        ...
        u'catalogue.elementdeprogramme': {
            ...
            'distribution': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'elements_de_programme'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalogue.AttributionDePupitre']"}),
        ...
        u'catalogue.partie': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': u"orm['catalogue.Partie']"}),
        ...
        u'catalogue.profession': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': u"orm['catalogue.Profession']"}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': 'None'})
        },
        u'catalogue.pupitre': {
