...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParenteDOeuvres.fille'
        db.alter_column('catalogue_parentedoeuvres', 'fille_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Oeuvre']))

        # Changing field 'ParenteDOeuvres.mere'
        db.alter_column('catalogue_parentedoeuvres', 'mere_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Oeuvre']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ParenteDOeuvres.fille'
        db.alter_column('catalogue_parentedoeuvres', 'fille_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Oeuvre']))

        # Changing field 'ParenteDOeuvres.mere'
        db.alter_column('catalogue_parentedoeuvres', 'mere_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Oeuvre']))
    ...
    models = {
        ...
        'catalogue.oeuvre': {
            ...
            'meres': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'filles'", 'symmetrical': 'False', 'through': "orm['catalogue.ParenteDOeuvres']", 'to': "orm['catalogue.Oeuvre']"}),
            'notes': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
