...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ElementDeProgramme.classement'
        db.delete_column('catalogue_elementdeprogramme', 'classement')


        # Changing field 'ElementDeProgramme.evenement'
        db.alter_column('catalogue_elementdeprogramme', 'evenement_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Evenement']))

        # Changing field 'ElementDeProgramme.position'
        db.alter_column('catalogue_elementdeprogramme', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))
        # Removing M2M table for field programme on 'Evenement'
        db.delete_table('catalogue_evenement_programme')


    def backwards(self, orm):
        # Adding field 'ElementDeProgramme.classement'
        db.add_column('catalogue_elementdeprogramme', 'classement',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)


        # Changing field 'ElementDeProgramme.evenement'
        db.alter_column('catalogue_elementdeprogramme', 'evenement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Evenement'], null=True))

        # Changing field 'ElementDeProgramme.position'
        db.alter_column('catalogue_elementdeprogramme', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
