...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('catalogue_profession', ['slug'])

        # Deleting field 'ParenteDIndividus.parent'
        db.delete_column('catalogue_parentedindividus', 'parent_id')

        # Deleting field 'ParenteDIndividus.enfant'
        db.delete_column('catalogue_parentedindividus', 'enfant_id')


        # Changing field 'TypeDeSource.slug'
        db.alter_column('catalogue_typedesource', 'slug', self.gf('autoslug'
                                                                  '.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Profession.slug'
        db.alter_column('catalogue_profession', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'NatureDeLieu.slug'
        db.alter_column('catalogue_naturedelieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Partie.slug'
        db.alter_column('catalogue_partie', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Individu.slug'
        db.alter_column('catalogue_individu', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))

        # Changing field 'Oeuvre.slug'
        db.alter_column('catalogue_oeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))

        # Changing field 'Lieu.slug'
        db.alter_column('catalogue_lieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))

        # Changing field 'GenreDOeuvre.slug'
        db.alter_column('catalogue_genredoeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Etat.slug'
        db.alter_column('catalogue_etat', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))
    ...
    models = {
        ...
        'catalogue.parentedindividus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'enfant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'autres_parentes'", 'null': 'True', 'to': "orm['catalogue.Individu']"}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'enfances'", 'null': 'True', 'to': "orm['catalogue.Individu']"}),
