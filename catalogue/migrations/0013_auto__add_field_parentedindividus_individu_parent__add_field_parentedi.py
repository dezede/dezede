...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_parentedindividus', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'enfances', null=True, to=orm['catalogue.Individu']),
                      keep_default=False)

        # Adding field 'ParenteDIndividus.enfant'
        db.add_column(u'catalogue_parentedindividus', 'enfant',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'autres_parentes', null=True, to=orm['catalogue.Individu']),
                      keep_default=False)


        # Changing field 'TypeDeSource.slug'
        db.alter_column(u'catalogue_typedesource', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'get_slug'))

        # Changing field 'Profession.slug'
        db.alter_column(u'catalogue_profession', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=u'get_slug', unique_with=()))
        # Adding unique constraint on 'Profession', fields ['slug']
        db.create_unique(u'catalogue_profession', ['slug'])


        # Changing field 'NatureDeLieu.slug'
        db.alter_column(u'catalogue_naturedelieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'get_slug'))

        # Changing field 'Partie.slug'
        db.alter_column(u'catalogue_partie', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'get_slug'))

        # Changing field 'Individu.slug'
        db.alter_column(u'catalogue_individu', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=u'get_slug', unique_with=()))

        # Changing field 'Oeuvre.slug'
        db.alter_column(u'catalogue_oeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=u'get_slug', unique_with=()))

        # Changing field 'Lieu.slug'
        db.alter_column(u'catalogue_lieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=u'get_slug', unique_with=()))

        # Changing field 'GenreDOeuvre.slug'
        db.alter_column(u'catalogue_genredoeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'get_slug'))

        # Changing field 'Etat.slug'
        db.alter_column(u'catalogue_etat', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'nom'))

    def backwards(self, orm):
        # Removing unique constraint on 'Profession', fields ['slug']
        db.delete_unique(u'catalogue_profession', ['slug'])

        # Deleting field 'ParenteDIndividus.parent'
        db.delete_column(u'catalogue_parentedindividus', 'parent_id')

        # Deleting field 'ParenteDIndividus.enfant'
        db.delete_column(u'catalogue_parentedindividus', 'enfant_id')


        # Changing field 'TypeDeSource.slug'
        db.alter_column(u'catalogue_typedesource', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Profession.slug'
        db.alter_column(u'catalogue_profession', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'NatureDeLieu.slug'
        db.alter_column(u'catalogue_naturedelieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Partie.slug'
        db.alter_column(u'catalogue_partie', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Individu.slug'
        db.alter_column(u'catalogue_individu', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))

        # Changing field 'Oeuvre.slug'
        db.alter_column(u'catalogue_oeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))

        # Changing field 'Lieu.slug'
        db.alter_column(u'catalogue_lieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))

        # Changing field 'GenreDOeuvre.slug'
        db.alter_column(u'catalogue_genredoeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))

        # Changing field 'Etat.slug'
        db.alter_column(u'catalogue_etat', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))
    ...
    models = {
        ...
        u'catalogue.individu': {
            ...
            'notes': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parentes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'individus_orig'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalogue.ParenteDIndividus']"}),
        ...
        u'catalogue.parentedindividus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'enfant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'autres_parentes'", 'null': 'True', 'to': u"orm['catalogue.Individu']"}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'enfances'", 'null': 'True', 'to': u"orm['catalogue.Individu']"}),
            'individus_cibles': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'enfances_cibles'", 'symmetrical': 'False', 'to': u"orm['catalogue.Individu']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
