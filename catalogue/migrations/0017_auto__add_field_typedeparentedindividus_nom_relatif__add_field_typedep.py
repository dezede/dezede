...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_typedeparentedindividus', 'nom_relatif_pluriel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=55, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TypeDeParenteDIndividus.nom_relatif'
        db.delete_column(u'catalogue_typedeparentedindividus', 'nom_relatif')

        # Deleting field 'TypeDeParenteDIndividus.nom_relatif_pluriel'
        db.delete_column(u'catalogue_typedeparentedindividus', 'nom_relatif_pluriel')
