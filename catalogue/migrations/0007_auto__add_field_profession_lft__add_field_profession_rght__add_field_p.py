...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_profession', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Profession.rght'
        db.add_column('catalogue_profession', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Profession.tree_id'
        db.add_column('catalogue_profession', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Profession.level'
        db.add_column('catalogue_profession', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Profession.parente'
        db.alter_column('catalogue_profession', 'parente_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['catalogue.Profession']))

    def backwards(self, orm):
        # Deleting field 'Profession.lft'
        db.delete_column('catalogue_profession', 'lft')

        # Deleting field 'Profession.rght'
        db.delete_column('catalogue_profession', 'rght')

        # Deleting field 'Profession.tree_id'
        db.delete_column('catalogue_profession', 'tree_id')

        # Deleting field 'Profession.level'
        db.delete_column('catalogue_profession', 'level')


        # Changing field 'Profession.parente'
        db.alter_column('catalogue_profession', 'parente_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Profession']))
    ...
    models = {
        ...
        'catalogue.profession': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': "orm['catalogue.Profession']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': 'None'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
