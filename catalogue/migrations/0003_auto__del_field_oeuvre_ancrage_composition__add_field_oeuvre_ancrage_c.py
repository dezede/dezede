...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Oeuvre.ancrage_composition' to 'Oeuvre.ancrage_creation'
        db.rename_column('catalogue_oeuvre', 'ancrage_composition_id', 'ancrage_creation_id')


    def backwards(self, orm):
        # Renaming field 'Oeuvre.ancrage_creation' to 'Oeuvre.ancrage_composition'
        db.rename_column('catalogue_oeuvre', 'ancrage_creation_id', 'ancrage_composition_id')
