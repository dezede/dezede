...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_typedesource', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'Profession.slug'
        db.alter_column('catalogue_profession', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'NatureDeLieu.slug'
        db.alter_column('catalogue_naturedelieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'GenreDOeuvre.slug'
        db.alter_column('catalogue_genredoeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'Individu.slug'
        db.alter_column('catalogue_individu', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'Oeuvre.slug'
        db.alter_column('catalogue_oeuvre', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'Lieu.slug'
        db.alter_column('catalogue_lieu', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))

        # Changing field 'Etat.slug'
        db.alter_column('catalogue_etat', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))


    def backwards(self, orm):
        
        # Changing field 'TypeDeSource.slug'
        db.alter_column('catalogue_typedesource', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Profession.slug'
        db.alter_column('catalogue_profession', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'NatureDeLieu.slug'
        db.alter_column('catalogue_naturedelieu', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'GenreDOeuvre.slug'
        db.alter_column('catalogue_genredoeuvre', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Individu.slug'
        db.alter_column('catalogue_individu', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Oeuvre.slug'
        db.alter_column('catalogue_oeuvre', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Lieu.slug'
        db.alter_column('catalogue_lieu', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Etat.slug'
        db.alter_column('catalogue_etat', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
