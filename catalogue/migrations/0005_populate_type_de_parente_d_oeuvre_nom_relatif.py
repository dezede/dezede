...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for t in orm['catalogue.TypeDeParenteDOeuvres'].objects.all():
            t.nom_relatif = 'parent de ' + t.nom[:90]
            t.save()
    ...
    models = {
        ...
        'catalogue.typedeparentedoeuvres': {
            ...
            'nom_relatif': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'null': 'True'}),
