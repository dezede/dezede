...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DossierDEvenements.etat'
        db.add_column(u'dossiers_dossierdevenements', 'etat',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DossierDEvenements.etat'
        db.delete_column(u'dossiers_dossierdevenements', 'etat_id')
