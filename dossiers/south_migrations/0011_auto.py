...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sources on 'DossierDEvenements'
        m2m_table_name = db.shorten_name(u'dossiers_dossierdevenements_sources')
        ...
        db.create_unique(m2m_table_name, ['dossierdevenements_id', 'source_id'])


    def backwards(self, orm):
        # Removing M2M table for field sources on 'DossierDEvenements'
        db.delete_table(db.shorten_name(u'dossiers_dossierdevenements_sources'))
