...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field ensembles on 'DossierDEvenements'
        m2m_table_name = db.shorten_name(u'dossiers_dossierdevenements_ensembles')
        ...
        db.create_unique(m2m_table_name, ['dossierdevenements_id', 'ensemble_id'])


    def backwards(self, orm):
        # Removing M2M table for field ensembles on 'DossierDEvenements'
        db.delete_table(db.shorten_name(u'dossiers_dossierdevenements_ensembles'))
    ...
    models = {
        ...
        u'libretto.evenement': {
            ...
            'relache': ('django.db.models.fields.BooleanField', [], {'db_index': 'True'})
        },
