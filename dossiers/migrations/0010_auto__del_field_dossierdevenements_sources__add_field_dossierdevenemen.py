...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'dossiers_dossierdevenements', 'sources', 'sources_et_protocole')


    def backwards(self, orm):
        db.rename_column(u'dossiers_dossierdevenements', 'sources_et_protocole', 'sources')
