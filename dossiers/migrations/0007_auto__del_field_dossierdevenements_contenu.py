...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DossierDEvenements.contenu'
        db.delete_column(u'dossiers_dossierdevenements', 'contenu')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DossierDEvenements.contenu'
        raise RuntimeError("Cannot reverse this migration. 'DossierDEvenements.contenu' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DossierDEvenements.contenu'
        db.add_column(u'dossiers_dossierdevenements', 'contenu',
