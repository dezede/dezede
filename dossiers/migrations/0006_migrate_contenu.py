...
class Migration(DataMigration):
    def forwards(self, orm):
        DossierDEvenements = orm['dossiers.DossierDEvenements']
        for dossier in DossierDEvenements.objects.all():
            dossier.presentation = dossier.contenu
            dossier.save()
            dossier.editeurs_scientifiques.add(dossier.owner)
