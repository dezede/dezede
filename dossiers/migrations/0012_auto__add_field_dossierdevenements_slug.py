...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DossierDEvenements.slug'
        db.add_column(u'dossiers_dossierdevenements', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DossierDEvenements.slug'
        db.delete_column(u'dossiers_dossierdevenements', 'slug')
