...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DossierDEvenements.titre_court'
        db.add_column(u'dossiers_dossierdevenements', 'titre_court',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DossierDEvenements.position'
        db.add_column(u'dossiers_dossierdevenements', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'DossierDEvenements.date_publication'
        db.add_column(u'dossiers_dossierdevenements', 'date_publication',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DossierDEvenements.publications'
        db.add_column(u'dossiers_dossierdevenements', 'publications',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DossierDEvenements.developpements'
        db.add_column(u'dossiers_dossierdevenements', 'developpements',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DossierDEvenements.presentation'
        db.add_column(u'dossiers_dossierdevenements', 'presentation',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DossierDEvenements.contexte'
        db.add_column(u'dossiers_dossierdevenements', 'contexte',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DossierDEvenements.sources'
        db.add_column(u'dossiers_dossierdevenements', 'sources',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DossierDEvenements.bibliographie'
        db.add_column(u'dossiers_dossierdevenements', 'bibliographie',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding M2M table for field editeurs_scientifiques on 'DossierDEvenements'
        m2m_table_name = db.shorten_name(u'dossiers_dossierdevenements_editeurs_scientifiques')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dossierdevenements', models.ForeignKey(orm[u'dossiers.dossierdevenements'], null=False)),
            ('hierarchicuser', models.ForeignKey(orm[u'accounts.hierarchicuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dossierdevenements_id', 'hierarchicuser_id'])


        # Changing field 'DossierDEvenements.owner'
        db.alter_column(u'dossiers_dossierdevenements', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

    def backwards(self, orm):
        # Deleting field 'DossierDEvenements.titre_court'
        db.delete_column(u'dossiers_dossierdevenements', 'titre_court')

        # Deleting field 'DossierDEvenements.position'
        db.delete_column(u'dossiers_dossierdevenements', 'position')

        # Deleting field 'DossierDEvenements.date_publication'
        db.delete_column(u'dossiers_dossierdevenements', 'date_publication')

        # Deleting field 'DossierDEvenements.publications'
        db.delete_column(u'dossiers_dossierdevenements', 'publications')

        # Deleting field 'DossierDEvenements.developpements'
        db.delete_column(u'dossiers_dossierdevenements', 'developpements')

        # Deleting field 'DossierDEvenements.presentation'
        db.delete_column(u'dossiers_dossierdevenements', 'presentation')

        # Deleting field 'DossierDEvenements.contexte'
        db.delete_column(u'dossiers_dossierdevenements', 'contexte')

        # Deleting field 'DossierDEvenements.sources'
        db.delete_column(u'dossiers_dossierdevenements', 'sources')

        # Deleting field 'DossierDEvenements.bibliographie'
        db.delete_column(u'dossiers_dossierdevenements', 'bibliographie')

        # Removing M2M table for field editeurs_scientifiques on 'DossierDEvenements'
        db.delete_table(db.shorten_name(u'dossiers_dossierdevenements_editeurs_scientifiques'))


        # Changing field 'DossierDEvenements.owner'
        db.alter_column(u'dossiers_dossierdevenements', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'dossiers.dossierdevenements': {
            'Meta': {'ordering': "(u'titre',)", 'object_name': 'DossierDEvenements'},
            ...
            'contexte': ('django.db.models.fields.TextField', [], {}),
