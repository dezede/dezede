...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DossierDEvenements'
        db.create_table(u'dossiers_dossierdevenements', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT, blank=True)),
            ...
            ('circonstance', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name=u'children', null=True, to=orm['dossiers.DossierDEvenements'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'dossiers', ['DossierDEvenements'])

        # Adding M2M table for field lieux on 'DossierDEvenements'
        db.create_table(u'dossiers_dossierdevenements_lieux', (
        ...
        db.create_unique(u'dossiers_dossierdevenements_lieux', ['dossierdevenements_id', 'lieu_id'])

        # Adding M2M table for field oeuvres on 'DossierDEvenements'
        db.create_table(u'dossiers_dossierdevenements_oeuvres', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dossierdevenements', models.ForeignKey(orm[u'dossiers.dossierdevenements'], null=False)),
            ('oeuvre', models.ForeignKey(orm[u'libretto.oeuvre'], null=False))
        ))
        db.create_unique(u'dossiers_dossierdevenements_oeuvres', ['dossierdevenements_id', 'oeuvre_id'])

        # Adding M2M table for field auteurs on 'DossierDEvenements'
        db.create_table(u'dossiers_dossierdevenements_auteurs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dossierdevenements', models.ForeignKey(orm[u'dossiers.dossierdevenements'], null=False)),
            ('individu', models.ForeignKey(orm[u'libretto.individu'], null=False))
        ))
        db.create_unique(u'dossiers_dossierdevenements_auteurs', ['dossierdevenements_id', 'individu_id'])

        # Adding M2M table for field evenements on 'DossierDEvenements'
        db.create_table(u'dossiers_dossierdevenements_evenements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dossierdevenements', models.ForeignKey(orm[u'dossiers.dossierdevenements'], null=False)),
            ('evenement', models.ForeignKey(orm[u'libretto.evenement'], null=False))
        ))
        db.create_unique(u'dossiers_dossierdevenements_evenements', ['dossierdevenements_id', 'evenement_id'])


    def backwards(self, orm):
        # Deleting model 'DossierDEvenements'
        db.delete_table(u'dossiers_dossierdevenements')

        # Removing M2M table for field lieux on 'DossierDEvenements'
        db.delete_table('dossiers_dossierdevenements_lieux')

        # Removing M2M table for field oeuvres on 'DossierDEvenements'
        db.delete_table('dossiers_dossierdevenements_oeuvres')

        # Removing M2M table for field auteurs on 'DossierDEvenements'
        db.delete_table('dossiers_dossierdevenements_auteurs')

        # Removing M2M table for field evenements on 'DossierDEvenements'
        db.delete_table('dossiers_dossierdevenements_evenements')
