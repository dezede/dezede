...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DossierDEvenements.etat'
        db.alter_column(u'dossiers_dossierdevenements', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'DossierDEvenements.etat'
        db.alter_column(u'dossiers_dossierdevenements', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))
