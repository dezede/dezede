...
apt-get install nano mercurial postgresql postgresql-server-dev-9.1 python2.7 python-pip python-docutils python-dev redis-server libxml2 libxml2-dev libxslt1-dev rabbitmq-server nodejs openjdk-7-jre
