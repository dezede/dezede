...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Individu.ancrage_approx'
        db.alter_column(u'catalogue_individu', 'ancrage_approx_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['catalogue.AncrageSpatioTemporel']))

        # Changing field 'Individu.ancrage_deces'
        db.alter_column(u'catalogue_individu', 'ancrage_deces_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['catalogue.AncrageSpatioTemporel']))

        # Changing field 'Individu.ancrage_naissance'
        db.alter_column(u'catalogue_individu', 'ancrage_naissance_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['catalogue.AncrageSpatioTemporel']))

        # Changing field 'Oeuvre.ancrage_creation'
        db.alter_column(u'catalogue_oeuvre', 'ancrage_creation_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['catalogue.AncrageSpatioTemporel']))

        # Changing field 'Evenement.ancrage_fin'
        db.alter_column(u'catalogue_evenement', 'ancrage_fin_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['catalogue.AncrageSpatioTemporel']))

        # Changing field 'Evenement.ancrage_debut'
        db.alter_column(u'catalogue_evenement', 'ancrage_debut_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['catalogue.AncrageSpatioTemporel']))

        # Changing field 'Auteur.individu'
        db.alter_column(u'catalogue_auteur', 'individu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Individu']))

        # Changing field 'Auteur.profession'
        db.alter_column(u'catalogue_auteur', 'profession_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Profession']))
