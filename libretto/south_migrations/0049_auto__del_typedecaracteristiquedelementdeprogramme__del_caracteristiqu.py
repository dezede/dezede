...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('libretto_typedecaracteristiquedelementdeprogramme',
                        'libretto_typedecaracteristiquedeprogramme')

        db.rename_table('libretto_caracteristiquedelementdeprogramme',
