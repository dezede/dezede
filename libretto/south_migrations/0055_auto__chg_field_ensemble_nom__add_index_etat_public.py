...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ensemble.nom'
        db.alter_column(u'libretto_ensemble', 'nom', self.gf('django.db.models.fields.CharField')(max_length=75))
        # Adding index on 'Etat', fields ['public']
        db.create_index(u'libretto_etat', ['public'])


    def backwards(self, orm):
        # Removing index on 'Etat', fields ['public']
        db.delete_index(u'libretto_etat', ['public'])


        # Changing field 'Ensemble.nom'
        db.alter_column(u'libretto_ensemble', 'nom', self.gf('django.db.models.fields.CharField')(max_length=50))
