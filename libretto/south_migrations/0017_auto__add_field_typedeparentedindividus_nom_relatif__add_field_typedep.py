...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catalogue_typedeparentedindividus', 'nom_relatif')

        # Deleting field 'TypeDeParenteDIndividus.nom_relatif_pluriel'
        db.delete_column('catalogue_typedeparentedindividus', 'nom_relatif_pluriel')
    ...
    models = {
        ...
        'catalogue.saison': {
            'Meta': {'ordering': "(u'lieu', u'debut')", 'object_name':
                'Saison'},
