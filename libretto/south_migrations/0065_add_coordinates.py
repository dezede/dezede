...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evenement.debut_date'
        db.alter_column(u'libretto_evenement', u'debut_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 1, 0, 0)))
        # Adding field 'Lieu.point'
        db.add_column(u'libretto_lieu', 'point',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Evenement.debut_date'
        db.alter_column(u'libretto_evenement', u'debut_date', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'Lieu.point'
        db.delete_column(u'libretto_lieu', 'point')
