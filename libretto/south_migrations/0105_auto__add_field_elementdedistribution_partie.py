...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElementDeDistribution.partie'
        db.add_column(u'libretto_elementdedistribution', 'partie',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'elements_de_distribution', null=True, on_delete=models.PROTECT, to=orm['libretto.Partie']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElementDeDistribution.partie'
        db.delete_column(u'libretto_elementdedistribution', 'partie_id')
