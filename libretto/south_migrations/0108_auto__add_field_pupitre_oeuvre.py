...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pupitre.oeuvre'
        db.add_column(u'libretto_pupitre', 'oeuvre',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', null=True, on_delete=models.PROTECT, to=orm['libretto.Oeuvre']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pupitre.oeuvre'
        db.delete_column(u'libretto_pupitre', 'oeuvre_id')
    ...
    models = {
        ...
        u'libretto.pupitre': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'oeuvre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['libretto.Oeuvre']"}),
