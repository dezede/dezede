...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catalogue_oeuvre', 'contenu_dans_id')

        # Deleting field 'Oeuvre.lft'
        db.delete_column('catalogue_oeuvre', 'lft')

        # Deleting field 'Oeuvre.rght'
        db.delete_column('catalogue_oeuvre', 'rght')

        # Deleting field 'Oeuvre.tree_id'
        db.delete_column('catalogue_oeuvre', 'tree_id')

        # Deleting field 'Oeuvre.level'
        db.delete_column('catalogue_oeuvre', 'level')

        # Deleting field 'GenreDOeuvre.referent'
        db.delete_column('catalogue_genredoeuvre', 'referent')
    ...
    models = {
        ...
        'catalogue.partie': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': "orm['catalogue.Partie']"}),
        ...
        'catalogue.profession': {
            ...
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '230', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'enfant'", 'null': 'True', 'to': "orm['catalogue.Profession']"}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': 'None'})
        },
        'catalogue.pupitre': {
