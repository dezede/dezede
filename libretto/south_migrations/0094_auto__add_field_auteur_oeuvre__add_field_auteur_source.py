...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auteur.oeuvre'
        db.add_column(u'libretto_auteur', 'oeuvre',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'auteurs', null=True, on_delete=models.PROTECT, to=orm['libretto.Oeuvre']),
                      keep_default=False)

        # Adding field 'Auteur.source'
        db.add_column(u'libretto_auteur', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'auteurs', null=True, on_delete=models.PROTECT, to=orm['libretto.Source']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auteur.oeuvre'
        db.delete_column(u'libretto_auteur', 'oeuvre_id')

        # Deleting field 'Auteur.source'
        db.delete_column(u'libretto_auteur', 'source_id')
