...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Auteur', fields ['content_type', 'object_id']
        db.create_index(u'libretto_auteur', ['content_type_id', 'object_id'])

        # Adding index on 'ElementDeDistribution', fields ['content_type', 'object_id']
        db.create_index(u'libretto_elementdedistribution', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing index on 'ElementDeDistribution', fields ['content_type', 'object_id']
        db.delete_index(u'libretto_elementdedistribution', ['content_type_id', 'object_id'])

        # Removing index on 'Auteur', fields ['content_type', 'object_id']
        db.delete_index(u'libretto_auteur', ['content_type_id', 'object_id'])
