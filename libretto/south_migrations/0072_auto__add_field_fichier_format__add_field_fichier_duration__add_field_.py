...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fichier.format'
        db.add_column(u'libretto_fichier', 'format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Fichier.duration'
        db.add_column(u'libretto_fichier', 'duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Fichier.width'
        db.add_column(u'libretto_fichier', 'width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Fichier.height'
        db.add_column(u'libretto_fichier', 'height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fichier.format'
        db.delete_column(u'libretto_fichier', 'format')

        # Deleting field 'Fichier.duration'
        db.delete_column(u'libretto_fichier', 'duration')

        # Deleting field 'Fichier.width'
        db.delete_column(u'libretto_fichier', 'width')

        # Deleting field 'Fichier.height'
        db.delete_column(u'libretto_fichier', 'height')
