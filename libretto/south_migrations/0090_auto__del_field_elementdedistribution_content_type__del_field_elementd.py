...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_index(u'libretto_elementdedistribution',
                        ['content_type_id', 'object_id'])

        # Deleting field 'ElementDeDistribution.content_type'
        db.delete_column(u'libretto_elementdedistribution', 'content_type_id')

        # Deleting field 'ElementDeDistribution.object_id'
        db.delete_column(u'libretto_elementdedistribution', 'object_id')


    def backwards(self, orm):
        # Adding field 'ElementDeDistribution.content_type'
        db.add_column(u'libretto_elementdedistribution', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'ElementDeDistribution.object_id'
        db.add_column(u'libretto_elementdedistribution', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding index on 'ElementDeDistribution', fields ['content_type', 'object_id']
        db.create_index(u'libretto_elementdedistribution',
                        ['content_type_id', 'object_id'])
