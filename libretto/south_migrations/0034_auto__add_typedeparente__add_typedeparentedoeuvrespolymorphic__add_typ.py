...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeDeParente'
        db.create_table(u'libretto_typedeparente', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_libretto.typedeparente_set', null=True, to=orm['contenttypes.ContentType'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'typedeparente', null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser'])),
        ...
        db.send_create_signal(u'libretto', ['TypeDeParente'])

        # Adding model 'TypeDeParenteDOeuvresPolymorphic'
        db.create_table(u'libretto_typedeparentedoeuvrespolymorphic', (
            (u'typedeparente_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['libretto.TypeDeParente'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['TypeDeParenteDOeuvresPolymorphic'])

        # Adding model 'TypeDeParenteDIndividusPolymorphic'
        db.create_table(u'libretto_typedeparentedindividuspolymorphic', (
            (u'typedeparente_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['libretto.TypeDeParente'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['TypeDeParenteDIndividusPolymorphic'])


    def backwards(self, orm):
        # Deleting model 'TypeDeParente'
        db.delete_table(u'libretto_typedeparente')

        # Deleting model 'TypeDeParenteDOeuvresPolymorphic'
        db.delete_table(u'libretto_typedeparentedoeuvrespolymorphic')

        # Deleting model 'TypeDeParenteDIndividusPolymorphic'
        db.delete_table(u'libretto_typedeparentedindividuspolymorphic')
