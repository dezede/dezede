...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evenement.fin_lieu'
        db.alter_column(u'libretto_evenement', u'fin_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Lieu']))

        # Changing field 'Evenement.debut_lieu'
        db.alter_column(u'libretto_evenement', u'debut_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Lieu']))

        # Changing field 'Individu.naissance_lieu'
        db.alter_column(u'libretto_individu', u'naissance_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Lieu']))

        # Changing field 'Individu.deces_lieu'
        db.alter_column(u'libretto_individu', u'deces_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Lieu']))

        # Changing field 'Oeuvre.creation_lieu'
        db.alter_column(u'libretto_oeuvre', u'creation_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Lieu']))

    def backwards(self, orm):

        # Changing field 'Evenement.fin_lieu'
        db.alter_column(u'libretto_evenement', u'fin_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Lieu']))

        # Changing field 'Evenement.debut_lieu'
        db.alter_column(u'libretto_evenement', u'debut_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Lieu']))

        # Changing field 'Individu.naissance_lieu'
        db.alter_column(u'libretto_individu', u'naissance_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Lieu']))

        # Changing field 'Individu.deces_lieu'
        db.alter_column(u'libretto_individu', u'deces_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Lieu']))

        # Changing field 'Oeuvre.creation_lieu'
        db.alter_column(u'libretto_oeuvre', u'creation_lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Lieu']))
