...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ElementDeDistribution.pupitre'
        db.delete_column(u'libretto_elementdedistribution', 'pupitre_id')


    def backwards(self, orm):
        # Adding field 'ElementDeDistribution.pupitre'
        db.add_column(u'libretto_elementdedistribution', 'pupitre',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'elements_de_distribution', null=True, to=orm['libretto.Pupitre'], on_delete=models.PROTECT, blank=True),
                      keep_default=False)
