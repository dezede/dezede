...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeDeCaracteristique'
        db.create_table(u'libretto_typedecaracteristique', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_libretto.typedecaracteristique_set', null=True, to=orm['contenttypes.ContentType'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'typedecaracteristique', null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser'])),
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, db_index=True)),
        ...
        db.send_create_signal(u'libretto', ['TypeDeCaracteristique'])

        # Adding model 'PolymorphicTypeDeCaracteristiqueDOeuvre'
        db.create_table(u'libretto_polymorphictypedecaracteristiquedoeuvre', (
        ...
        db.send_create_signal(u'libretto', ['PolymorphicTypeDeCaracteristiqueDOeuvre'])


    def backwards(self, orm):
        # Deleting model 'TypeDeCaracteristique'
        db.delete_table(u'libretto_typedecaracteristique')

        # Deleting model 'PolymorphicTypeDeCaracteristiqueDOeuvre'
        db.delete_table(u'libretto_polymorphictypedecaracteristiquedoeuvre')
    ...
    models = {
        ...
        u'libretto.polymorphictypedecaracteristiquedoeuvre': {
            'Meta': {'ordering': "(u'classement',)", 'object_name': 'PolymorphicTypeDeCaracteristiqueDOeuvre', '_ormbases': [u'libretto.TypeDeCaracteristique']},
