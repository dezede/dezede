...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('libretto_typedeparentedoeuvrespolymorphic',
                        'libretto_typedeparentedoeuvres')

        db.rename_table('libretto_typedeparentedindividuspolymorphic',
                        'libretto_typedeparentedindividus')
