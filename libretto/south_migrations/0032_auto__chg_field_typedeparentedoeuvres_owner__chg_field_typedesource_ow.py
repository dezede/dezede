...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'libretto_typedeparentedoeuvres', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'TypeDeSource.owner'
        db.alter_column(u'libretto_typedesource', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'GenreDOeuvre.owner'
        db.alter_column(u'libretto_genredoeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Evenement.owner'
        db.alter_column(u'libretto_evenement', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Individu.owner'
        db.alter_column(u'libretto_individu', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Pupitre.owner'
        db.alter_column(u'libretto_pupitre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Source.owner'
        db.alter_column(u'libretto_source', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Oeuvre.owner'
        db.alter_column(u'libretto_oeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Prenom.owner'
        db.alter_column(u'libretto_prenom', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'TypeDePersonnel.owner'
        db.alter_column(u'libretto_typedepersonnel', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Auteur.owner'
        db.alter_column(u'libretto_auteur', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Engagement.owner'
        db.alter_column(u'libretto_engagement', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Saison.owner'
        db.alter_column(u'libretto_saison', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'NatureDeLieu.owner'
        db.alter_column(u'libretto_naturedelieu', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'ParenteDIndividus.owner'
        db.alter_column(u'libretto_parentedindividus', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'AncrageSpatioTemporel.owner'
        db.alter_column(u'libretto_ancragespatiotemporel', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Profession.owner'
        db.alter_column(u'libretto_profession', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'CaracteristiqueDElementDeProgramme.owner'
        db.alter_column(u'libretto_caracteristiquedelementdeprogramme', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'ElementDeProgramme.owner'
        db.alter_column(u'libretto_elementdeprogramme', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Devise.owner'
        db.alter_column(u'libretto_devise', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'TypeDeParenteDIndividus.owner'
        db.alter_column(u'libretto_typedeparentedindividus', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Etat.owner'
        db.alter_column(u'libretto_etat', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'ParenteDOeuvres.owner'
        db.alter_column(u'libretto_parentedoeuvres', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Illustration.owner'
        db.alter_column(u'libretto_illustration', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Personnel.owner'
        db.alter_column(u'libretto_personnel', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'ElementDeDistribution.owner'
        db.alter_column(u'libretto_elementdedistribution', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'CaracteristiqueDOeuvre.owner'
        db.alter_column(u'libretto_caracteristiquedoeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'TypeDeCaracteristiqueDOeuvre.owner'
        db.alter_column(u'libretto_typedecaracteristiquedoeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Lieu.owner'
        db.alter_column(u'libretto_lieu', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Partie.owner'
        db.alter_column(u'libretto_partie', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

        # Changing field 'Document.owner'
        db.alter_column(u'libretto_document', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser']))

    def backwards(self, orm):

        # Changing field 'TypeDeParenteDOeuvres.owner'
        db.alter_column(u'libretto_typedeparentedoeuvres', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'TypeDeSource.owner'
        db.alter_column(u'libretto_typedesource', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'GenreDOeuvre.owner'
        db.alter_column(u'libretto_genredoeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Evenement.owner'
        db.alter_column(u'libretto_evenement', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Individu.owner'
        db.alter_column(u'libretto_individu', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Pupitre.owner'
        db.alter_column(u'libretto_pupitre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Source.owner'
        db.alter_column(u'libretto_source', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Oeuvre.owner'
        db.alter_column(u'libretto_oeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Prenom.owner'
        db.alter_column(u'libretto_prenom', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'TypeDePersonnel.owner'
        db.alter_column(u'libretto_typedepersonnel', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Auteur.owner'
        db.alter_column(u'libretto_auteur', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Engagement.owner'
        db.alter_column(u'libretto_engagement', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Saison.owner'
        db.alter_column(u'libretto_saison', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'NatureDeLieu.owner'
        db.alter_column(u'libretto_naturedelieu', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'ParenteDIndividus.owner'
        db.alter_column(u'libretto_parentedindividus', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'AncrageSpatioTemporel.owner'
        db.alter_column(u'libretto_ancragespatiotemporel', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Profession.owner'
        db.alter_column(u'libretto_profession', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'CaracteristiqueDElementDeProgramme.owner'
        db.alter_column(u'libretto_caracteristiquedelementdeprogramme', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'ElementDeProgramme.owner'
        db.alter_column(u'libretto_elementdeprogramme', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Devise.owner'
        db.alter_column(u'libretto_devise', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'TypeDeParenteDIndividus.owner'
        db.alter_column(u'libretto_typedeparentedindividus', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Etat.owner'
        db.alter_column(u'libretto_etat', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'ParenteDOeuvres.owner'
        db.alter_column(u'libretto_parentedoeuvres', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Illustration.owner'
        db.alter_column(u'libretto_illustration', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Personnel.owner'
        db.alter_column(u'libretto_personnel', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'ElementDeDistribution.owner'
        db.alter_column(u'libretto_elementdedistribution', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'CaracteristiqueDOeuvre.owner'
        db.alter_column(u'libretto_caracteristiquedoeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'TypeDeCaracteristiqueDOeuvre.owner'
        db.alter_column(u'libretto_typedecaracteristiquedoeuvre', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Lieu.owner'
        db.alter_column(u'libretto_lieu', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Partie.owner'
        db.alter_column(u'libretto_partie', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Document.owner'
        db.alter_column(u'libretto_document', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))
