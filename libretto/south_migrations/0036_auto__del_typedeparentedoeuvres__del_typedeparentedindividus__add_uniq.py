...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'libretto_typedeparentedoeuvres')

        # Deleting model 'TypeDeParenteDIndividus'
        db.delete_table(u'libretto_typedeparentedindividus')

        # Adding unique constraint on 'TypeDeParente', fields ['nom', 'nom_relatif']
        db.create_unique(u'libretto_typedeparente', ['nom', 'nom_relatif'])


        # Changing field 'ParenteDIndividus.type'
        db.alter_column(u'libretto_parentedindividus', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['libretto.TypeDeParenteDIndividusPolymorphic']))

        # Changing field 'ParenteDOeuvres.type'
        db.alter_column(u'libretto_parentedoeuvres', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['libretto.TypeDeParenteDOeuvresPolymorphic']))

    def backwards(self, orm):
        # Removing unique constraint on 'TypeDeParente', fields ['nom', 'nom_relatif']
        db.delete_unique(u'libretto_typedeparente', ['nom', 'nom_relatif'])

        # Adding model 'TypeDeParenteDOeuvres'
        db.create_table(u'libretto_typedeparentedoeuvres', (
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('nom_relatif', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('classement', self.gf('django.db.models.fields.SmallIntegerField')(default=1, db_index=True)),
            ('nom_pluriel', self.gf('django.db.models.fields.CharField')(max_length=55, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'typedeparentedoeuvres', null=True, to=orm['accounts.HierarchicUser'], on_delete=models.PROTECT, blank=True)),
            ('nom_relatif_pluriel', self.gf('django.db.models.fields.CharField')(max_length=130, blank=True)),
        ))
        db.send_create_signal(u'libretto', ['TypeDeParenteDOeuvres'])

        # Adding model 'TypeDeParenteDIndividus'
        db.create_table(u'libretto_typedeparentedindividus', (
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('nom_relatif', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('classement', self.gf('django.db.models.fields.SmallIntegerField')(default=1, db_index=True)),
            ('nom_pluriel', self.gf('django.db.models.fields.CharField')(max_length=55, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'typedeparentedindividus', null=True, to=orm['accounts.HierarchicUser'], on_delete=models.PROTECT, blank=True)),
            ('nom_relatif_pluriel', self.gf('django.db.models.fields.CharField')(max_length=130, blank=True)),
        ))
        db.send_create_signal(u'libretto', ['TypeDeParenteDIndividus'])


        # Changing field 'ParenteDIndividus.type'
        db.alter_column(u'libretto_parentedindividus', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['libretto.TypeDeParenteDIndividus']))

        # Changing field 'ParenteDOeuvres.type'
        db.alter_column(u'libretto_parentedoeuvres', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['libretto.TypeDeParenteDOeuvres']))
