...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oeuvre.tempo'
        db.add_column(u'libretto_oeuvre', 'tempo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=92, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.type_extrait'
        db.add_column(u'libretto_oeuvre', 'type_extrait',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.numero_extrait'
        db.add_column(u'libretto_oeuvre', 'numero_extrait',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oeuvre.tempo'
        db.delete_column(u'libretto_oeuvre', 'tempo')

        # Deleting field 'Oeuvre.type_extrait'
        db.delete_column(u'libretto_oeuvre', 'type_extrait')

        # Deleting field 'Oeuvre.numero_extrait'
        db.delete_column(u'libretto_oeuvre', 'numero_extrait')
