...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Oeuvre.lilypond'
        db.delete_column(u'libretto_oeuvre', 'lilypond')

        # Deleting field 'Oeuvre.description'
        db.delete_column(u'libretto_oeuvre', 'description')


    def backwards(self, orm):
        # Adding field 'Oeuvre.lilypond'
        db.add_column(u'libretto_oeuvre', 'lilypond',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.description'
        db.add_column(u'libretto_oeuvre', 'description',
