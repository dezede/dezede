...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evenement.programme_incomplet'
        db.add_column(u'libretto_evenement', 'programme_incomplet',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Evenement.recette_generale'
        db.add_column(u'libretto_evenement', 'recette_generale',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.recette_par_billets'
        db.add_column(u'libretto_evenement', 'recette_par_billets',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding index on 'Source', fields ['lieu_conservation']
        db.create_index(u'libretto_source', ['lieu_conservation'])

        # Adding index on 'Source', fields ['cote']
        db.create_index(u'libretto_source', ['cote'])

        # Adding index on 'Source', fields ['page']
        db.create_index(u'libretto_source', ['page'])

        # Adding field 'ElementDeProgramme.part_d_auteur'
        db.add_column(u'libretto_elementdeprogramme', 'part_d_auteur',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding index on 'ElementDeProgramme', fields ['position']
        db.create_index(u'libretto_elementdeprogramme', ['position'])


    def backwards(self, orm):
        # Removing index on 'ElementDeProgramme', fields ['position']
        db.delete_index(u'libretto_elementdeprogramme', ['position'])

        # Removing index on 'Source', fields ['page']
        db.delete_index(u'libretto_source', ['page'])

        # Removing index on 'Source', fields ['cote']
        db.delete_index(u'libretto_source', ['cote'])

        # Removing index on 'Source', fields ['lieu_conservation']
        db.delete_index(u'libretto_source', ['lieu_conservation'])

        # Deleting field 'Evenement.programme_incomplet'
        db.delete_column(u'libretto_evenement', 'programme_incomplet')

        # Deleting field 'Evenement.recette_generale'
        db.delete_column(u'libretto_evenement', 'recette_generale')

        # Deleting field 'Evenement.recette_par_billets'
        db.delete_column(u'libretto_evenement', 'recette_par_billets')

        # Deleting field 'ElementDeProgramme.part_d_auteur'
        db.delete_column(u'libretto_elementdeprogramme', 'part_d_auteur')
    ...
    models = {
        ...
        u'libretto.elementdedistribution': {
            'Meta': {'ordering': "(u'pupitre', u'profession')", 'object_name': 'ElementDeDistribution', 'index_together': "((u'content_type', u'object_id'),)"},
