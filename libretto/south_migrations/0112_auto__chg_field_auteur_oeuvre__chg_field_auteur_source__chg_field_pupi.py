...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auteur.oeuvre'
        db.alter_column(u'libretto_auteur', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Oeuvre']))

        # Changing field 'Auteur.source'
        db.alter_column(u'libretto_auteur', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Source']))

        # Changing field 'Pupitre.oeuvre'
        db.alter_column(u'libretto_pupitre', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Oeuvre']))

        # Changing field 'ElementDeDistribution.evenement'
        db.alter_column(u'libretto_elementdedistribution', 'evenement_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Evenement']))

    def backwards(self, orm):

        # Changing field 'Auteur.oeuvre'
        db.alter_column(u'libretto_auteur', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Oeuvre'], on_delete=models.PROTECT))

        # Changing field 'Auteur.source'
        db.alter_column(u'libretto_auteur', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Source'], on_delete=models.PROTECT))

        # Changing field 'Pupitre.oeuvre'
        db.alter_column(u'libretto_pupitre', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['libretto.Oeuvre']))

        # Changing field 'ElementDeDistribution.evenement'
        db.alter_column(u'libretto_elementdedistribution', 'evenement_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Evenement'], on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'libretto.pupitre': {
            ...
            'soliste': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        u'libretto.role': {
