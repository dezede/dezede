...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElementDeDistribution.evenement'
        db.add_column(u'libretto_elementdedistribution', 'evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'distribution', null=True, on_delete=models.PROTECT, to=orm['libretto.Evenement']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElementDeDistribution.evenement'
        db.delete_column(u'libretto_elementdedistribution', 'evenement_id')
