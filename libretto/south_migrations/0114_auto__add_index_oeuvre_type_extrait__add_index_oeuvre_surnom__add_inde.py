...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Oeuvre', fields ['type_extrait']
        db.create_index(u'libretto_oeuvre', ['type_extrait'])

        # Adding index on 'Oeuvre', fields ['surnom']
        db.create_index(u'libretto_oeuvre', ['surnom'])

        # Adding index on 'Oeuvre', fields ['coupe']
        db.create_index(u'libretto_oeuvre', ['coupe'])

        # Adding index on 'Oeuvre', fields ['opus']
        db.create_index(u'libretto_oeuvre', ['opus'])

        # Adding index on 'Oeuvre', fields ['numero_extrait']
        db.create_index(u'libretto_oeuvre', ['numero_extrait'])

        # Adding index on 'Oeuvre', fields ['ict']
        db.create_index(u'libretto_oeuvre', ['ict'])

        # Adding index on 'Oeuvre', fields ['incipit']
        db.create_index(u'libretto_oeuvre', ['incipit'])

        # Adding index on 'Oeuvre', fields ['tempo']
        db.create_index(u'libretto_oeuvre', ['tempo'])

        # Adding index on 'Oeuvre', fields ['numero']
        db.create_index(u'libretto_oeuvre', ['numero'])

        # Adding index on 'Oeuvre', fields ['nom_courant']
        db.create_index(u'libretto_oeuvre', ['nom_courant'])

        # Adding index on 'Oeuvre', fields ['tonalite']
        db.create_index(u'libretto_oeuvre', ['tonalite'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Oeuvre', fields ['tonalite']
        db.delete_index(u'libretto_oeuvre', ['tonalite'])

        # Removing index on 'Oeuvre', fields ['nom_courant']
        db.delete_index(u'libretto_oeuvre', ['nom_courant'])

        # Removing index on 'Oeuvre', fields ['numero']
        db.delete_index(u'libretto_oeuvre', ['numero'])

        # Removing index on 'Oeuvre', fields ['tempo']
        db.delete_index(u'libretto_oeuvre', ['tempo'])

        # Removing index on 'Oeuvre', fields ['incipit']
        db.delete_index(u'libretto_oeuvre', ['incipit'])

        # Removing index on 'Oeuvre', fields ['ict']
        db.delete_index(u'libretto_oeuvre', ['ict'])

        # Removing index on 'Oeuvre', fields ['numero_extrait']
        db.delete_index(u'libretto_oeuvre', ['numero_extrait'])

        # Removing index on 'Oeuvre', fields ['opus']
        db.delete_index(u'libretto_oeuvre', ['opus'])

        # Removing index on 'Oeuvre', fields ['coupe']
        db.delete_index(u'libretto_oeuvre', ['coupe'])

        # Removing index on 'Oeuvre', fields ['surnom']
        db.delete_index(u'libretto_oeuvre', ['surnom'])

        # Removing index on 'Oeuvre', fields ['type_extrait']
        db.delete_index(u'libretto_oeuvre', ['type_extrait'])
