...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'libretto_evenement', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_individu', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_source', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_profession', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_oeuvre', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_ensemble', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_lieu', 'notes', 'notes_publiques')
        db.rename_column(u'libretto_partie', 'notes', 'notes_publiques')

        # Adding field 'Evenement.notes_privees'
        db.add_column(u'libretto_evenement', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Individu.notes_privees'
        db.add_column(u'libretto_individu', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Source.notes_privees'
        db.add_column(u'libretto_source', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Profession.notes_privees'
        db.add_column(u'libretto_profession', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.notes_privees'
        db.add_column(u'libretto_oeuvre', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Ensemble.notes_privees'
        db.add_column(u'libretto_ensemble', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Lieu.notes_privees'
        db.add_column(u'libretto_lieu', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Partie.notes_privees'
        db.add_column(u'libretto_partie', 'notes_privees',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)
