...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oeuvre.numero'
        db.add_column(u'libretto_oeuvre', 'numero',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.opus'
        db.add_column(u'libretto_oeuvre', 'opus',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.tonalite'
        db.add_column(u'libretto_oeuvre', 'tonalite',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.ict'
        db.add_column(u'libretto_oeuvre', 'ict',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.surnom'
        db.add_column(u'libretto_oeuvre', 'surnom',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.incipit'
        db.add_column(u'libretto_oeuvre', 'incipit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Oeuvre.nom_courant'
        db.add_column(u'libretto_oeuvre', 'nom_courant',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=70, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oeuvre.numero'
        db.delete_column(u'libretto_oeuvre', 'numero')

        # Deleting field 'Oeuvre.opus'
        db.delete_column(u'libretto_oeuvre', 'opus')

        # Deleting field 'Oeuvre.tonalite'
        db.delete_column(u'libretto_oeuvre', 'tonalite')

        # Deleting field 'Oeuvre.ict'
        db.delete_column(u'libretto_oeuvre', 'ict')

        # Deleting field 'Oeuvre.surnom'
        db.delete_column(u'libretto_oeuvre', 'surnom')

        # Deleting field 'Oeuvre.incipit'
        db.delete_column(u'libretto_oeuvre', 'incipit')

        # Deleting field 'Oeuvre.nom_courant'
        db.delete_column(u'libretto_oeuvre', 'nom_courant')
