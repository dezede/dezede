...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'libretto_etat', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=u'get_slug', unique_with=()))
        # Adding unique constraint on 'Etat', fields ['slug']
        db.create_unique(u'libretto_etat', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Etat', fields ['slug']
        db.delete_unique(u'libretto_etat', ['slug'])


        # Changing field 'Etat.slug'
        db.alter_column(u'libretto_etat', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=u'nom'))
    ...
    models = {
        ...
        u'libretto.elementdeprogramme': {
            ...
            'etat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Etat']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
