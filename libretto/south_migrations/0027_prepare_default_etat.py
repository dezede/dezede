...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        default_etat = orm['libretto.Etat'].objects.get_or_create(
            nom='nouveau', defaults={
        ...
        for model_name in ('Oeuvre', 'Profession', 'Evenement',
                           'ElementDeProgramme', 'Partie', 'Lieu', 'Source',
                           'Individu'):
            model = orm['libretto.' + model_name]
            model.objects.filter(etat=None).update(etat=default_etat)
