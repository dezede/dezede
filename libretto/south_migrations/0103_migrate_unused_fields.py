...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        oeuvres_w_lilypond = Oeuvre.objects.exclude(lilypond='')
        oeuvres_w_description = Oeuvre.objects.exclude(description='')

        for oeuvre in oeuvres_w_lilypond:
            oeuvre.notes_publiques += '<p>%s</p>' % oeuvre.lilypond
            oeuvre.save()

        for oeuvre in oeuvres_w_description:
            oeuvre.notes_publiques += oeuvre.description
            oeuvre.save()
