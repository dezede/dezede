...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Oeuvre.tempo'
        db.alter_column(u'libretto_oeuvre', 'tempo', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Oeuvre.tempo'
        db.alter_column(u'libretto_oeuvre', 'tempo', self.gf('django.db.models.fields.CharField')(max_length=92))
    ...
    models = {
        ...
        u'libretto.oeuvre': {
            ...
            'tempo': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
