...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CaracteristiqueDEnsemble'
        db.delete_table(u'libretto_caracteristiquedensemble')

        # Deleting model 'TypeDeCaracteristiqueDEnsemble'
        db.delete_table(u'libretto_typedecaracteristiquedensemble')

        # Removing M2M table for field caracteristiques on 'Ensemble'
        db.delete_table(db.shorten_name(u'libretto_ensemble_caracteristiques'))


    def backwards(self, orm):
        # Adding model 'CaracteristiqueDEnsemble'
        db.create_table(u'libretto_caracteristiquedensemble', (
            (u'caracteristique_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['libretto.Caracteristique'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['CaracteristiqueDEnsemble'])

        # Adding model 'TypeDeCaracteristiqueDEnsemble'
        db.create_table(u'libretto_typedecaracteristiquedensemble', (
            (u'typedecaracteristique_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['libretto.TypeDeCaracteristique'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['TypeDeCaracteristiqueDEnsemble'])

        # Adding M2M table for field caracteristiques on 'Ensemble'
        m2m_table_name = db.shorten_name(u'libretto_ensemble_caracteristiques')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ensemble', models.ForeignKey(orm[u'libretto.ensemble'], null=False)),
            ('caracteristiquedensemble', models.ForeignKey(orm[u'libretto.caracteristiquedensemble'], null=False))
        ))
        db.create_unique(m2m_table_name, ['ensemble_id', 'caracteristiquedensemble_id'])
    ...
    models = {
        ...
        u'libretto.auteur': {
            'Meta': {'ordering': "(u'profession', u'individu')", 'object_name': 'Auteur'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'oeuvre': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'auteurs'", 'null': 'True', 'to': u"orm['libretto.Oeuvre']"}),
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'auteurs'", 'null': 'True', 'to': u"orm['libretto.Source']"})
        },
        ...
        u'libretto.elementdedistribution': {
            ...
            'evenement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'distribution'", 'null': 'True', 'to': u"orm['libretto.Evenement']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'libretto.elementdeprogramme': {
            'Meta': {'ordering': "(u'position',)", 'object_name': 'ElementDeProgramme'},
        ...
        u'libretto.ensemble': {
            'Meta': {'ordering': "(u'nom',)", 'object_name': 'Ensemble'},
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ensembles'", 'null': 'True', 'to': u"orm['libretto.TypeDEnsemble']"})
        },
        u'libretto.etat': {
        ...
        u'libretto.evenement': {
            'Meta': {'ordering': "(u'debut_date', u'debut_heure', u'debut_lieu', u'debut_lieu_approx')", 'object_name': 'Evenement'},
        ...
        u'libretto.genredoeuvre': {
            'Meta': {'ordering': "(u'nom',)", 'object_name': 'GenreDOeuvre'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'libretto.oeuvre': {
            ...
            'caracteristiques': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'oeuvres'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['libretto.CaracteristiqueDOeuvre']"}),
            'coordination': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'blank': 'True'}),
            'coupe': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '100', 'blank': 'True'}),
            ...
            'ict': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '25', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incipit': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '100', 'blank': 'True'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'nom_courant': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '70', 'blank': 'True'}),
            'notes_privees': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'notes_publiques': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'numero': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '5', 'blank': 'True'}),
            'numero_extrait': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '5', 'blank': 'True'}),
            'opus': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '5', 'blank': 'True'}),
            ...
            'surnom': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'tempo': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            ...
            'tonalite': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '3', 'blank': 'True'}),
            u'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'type_extrait': ('django.db.models.fields.PositiveSmallIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'libretto.pupitre': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'oeuvre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'pupitres'", 'to': u"orm['libretto.Oeuvre']"}),
            ...
            'soliste': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        u'libretto.role': {
        ...
        u'libretto.typedensemble': {
            'Meta': {'ordering': "(u'nom',)", 'object_name': 'TypeDEnsemble'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'nom_pluriel': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'typedensemble'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['accounts.HierarchicUser']"}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "u'enfants'", 'null': 'True', 'to': u"orm['libretto.TypeDEnsemble']"}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
