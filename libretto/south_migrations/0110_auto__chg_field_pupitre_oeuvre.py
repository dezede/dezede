...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'libretto_pupitre', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, on_delete=models.PROTECT, to=orm['libretto.Oeuvre']))
        # Removing M2M table for field pupitres on 'Oeuvre'
        db.delete_table(db.shorten_name(u'libretto_oeuvre_pupitres'))


    def backwards(self, orm):

        # Changing field 'Pupitre.oeuvre'
        db.alter_column(u'libretto_pupitre', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Oeuvre']))
        # Adding M2M table for field pupitres on 'Oeuvre'
        m2m_table_name = db.shorten_name(u'libretto_oeuvre_pupitres')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oeuvre', models.ForeignKey(orm[u'libretto.oeuvre'], null=False)),
            ('pupitre', models.ForeignKey(orm[u'libretto.pupitre'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oeuvre_id', 'pupitre_id'])
    ...
    models = {
        ...
        u'libretto.pupitre': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'oeuvre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'pupitres'", 'on_delete': 'models.PROTECT', 'to': u"orm['libretto.Oeuvre']"}),
