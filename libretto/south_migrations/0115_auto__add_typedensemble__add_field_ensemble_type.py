...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeDEnsemble'
        db.create_table(u'libretto_typedensemble', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'typedensemble', null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser'])),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('nom_pluriel', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name=u'enfants', null=True, to=orm['libretto.TypeDEnsemble'])),
            (u'lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'libretto', ['TypeDEnsemble'])

        # Adding field 'Ensemble.type'
        db.add_column(u'libretto_ensemble', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ensembles', null=True, to=orm['libretto.TypeDEnsemble']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TypeDEnsemble'
        db.delete_table(u'libretto_typedensemble')

        # Deleting field 'Ensemble.type'
        db.delete_column(u'libretto_ensemble', 'type_id')
