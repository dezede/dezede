...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'libretto_illustration')

        # Deleting model 'Document'
        db.delete_table(u'libretto_document')

        # Removing M2M table for field documents on 'Evenement'
        db.delete_table(db.shorten_name(u'libretto_evenement_documents'))

        # Removing M2M table for field illustrations on 'Evenement'
        db.delete_table(db.shorten_name(u'libretto_evenement_illustrations'))

        # Removing M2M table for field documents on 'Individu'
        db.delete_table(db.shorten_name(u'libretto_individu_documents'))

        # Removing M2M table for field illustrations on 'Individu'
        db.delete_table(db.shorten_name(u'libretto_individu_illustrations'))

        # Removing M2M table for field documents on 'Source'
        db.delete_table(db.shorten_name(u'libretto_source_documents'))

        # Removing M2M table for field illustrations on 'Source'
        db.delete_table(db.shorten_name(u'libretto_source_illustrations'))

        # Removing M2M table for field illustrations on 'Profession'
        db.delete_table(db.shorten_name(u'libretto_profession_illustrations'))

        # Removing M2M table for field documents on 'Profession'
        db.delete_table(db.shorten_name(u'libretto_profession_documents'))

        # Removing M2M table for field documents on 'Oeuvre'
        db.delete_table(db.shorten_name(u'libretto_oeuvre_documents'))

        # Removing M2M table for field illustrations on 'Oeuvre'
        db.delete_table(db.shorten_name(u'libretto_oeuvre_illustrations'))

        # Removing M2M table for field documents on 'Ensemble'
        db.delete_table(db.shorten_name(u'libretto_ensemble_documents'))

        # Removing M2M table for field illustrations on 'Ensemble'
        db.delete_table(db.shorten_name(u'libretto_ensemble_illustrations'))

        # Removing M2M table for field documents on 'Lieu'
        db.delete_table(db.shorten_name(u'libretto_lieu_documents'))

        # Removing M2M table for field illustrations on 'Lieu'
        db.delete_table(db.shorten_name(u'libretto_lieu_illustrations'))

        # Removing M2M table for field illustrations on 'Partie'
        db.delete_table(db.shorten_name(u'libretto_partie_illustrations'))

        # Removing M2M table for field documents on 'Partie'
        db.delete_table(db.shorten_name(u'libretto_partie_documents'))


    def backwards(self, orm):
        # Adding model 'Illustration'
        db.create_table(u'libretto_illustration', (
            ('commentaire', self.gf('tinymce.models.HTMLField')(blank=True)),
            ('image', self.gf('filebrowser.fields.FileBrowseField')(max_length=400)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'illustration', null=True, to=orm['accounts.HierarchicUser'], on_delete=models.PROTECT, blank=True)),
            ('legende', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['Illustration'])

        # Adding model 'Document'
        db.create_table(u'libretto_document', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'document', null=True, to=orm['accounts.HierarchicUser'], on_delete=models.PROTECT, blank=True)),
            ('document', self.gf('filebrowser.fields.FileBrowseField')(max_length=400)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['Document'])

        # Adding M2M table for field documents on 'Evenement'
        m2m_table_name = db.shorten_name(u'libretto_evenement_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evenement', models.ForeignKey(orm[u'libretto.evenement'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['evenement_id', 'document_id'])

        # Adding M2M table for field illustrations on 'Evenement'
        m2m_table_name = db.shorten_name(u'libretto_evenement_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evenement', models.ForeignKey(orm[u'libretto.evenement'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['evenement_id', 'illustration_id'])

        # Adding M2M table for field documents on 'Individu'
        m2m_table_name = db.shorten_name(u'libretto_individu_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('individu', models.ForeignKey(orm[u'libretto.individu'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['individu_id', 'document_id'])

        # Adding M2M table for field illustrations on 'Individu'
        m2m_table_name = db.shorten_name(u'libretto_individu_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('individu', models.ForeignKey(orm[u'libretto.individu'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['individu_id', 'illustration_id'])

        # Adding M2M table for field documents on 'Source'
        m2m_table_name = db.shorten_name(u'libretto_source_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('source', models.ForeignKey(orm[u'libretto.source'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['source_id', 'document_id'])

        # Adding M2M table for field illustrations on 'Source'
        m2m_table_name = db.shorten_name(u'libretto_source_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('source', models.ForeignKey(orm[u'libretto.source'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['source_id', 'illustration_id'])

        # Adding M2M table for field illustrations on 'Profession'
        m2m_table_name = db.shorten_name(u'libretto_profession_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profession', models.ForeignKey(orm[u'libretto.profession'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profession_id', 'illustration_id'])

        # Adding M2M table for field documents on 'Profession'
        m2m_table_name = db.shorten_name(u'libretto_profession_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profession', models.ForeignKey(orm[u'libretto.profession'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profession_id', 'document_id'])

        # Adding M2M table for field documents on 'Oeuvre'
        m2m_table_name = db.shorten_name(u'libretto_oeuvre_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oeuvre', models.ForeignKey(orm[u'libretto.oeuvre'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oeuvre_id', 'document_id'])

        # Adding M2M table for field illustrations on 'Oeuvre'
        m2m_table_name = db.shorten_name(u'libretto_oeuvre_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oeuvre', models.ForeignKey(orm[u'libretto.oeuvre'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oeuvre_id', 'illustration_id'])

        # Adding M2M table for field documents on 'Ensemble'
        m2m_table_name = db.shorten_name(u'libretto_ensemble_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ensemble', models.ForeignKey(orm[u'libretto.ensemble'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['ensemble_id', 'document_id'])

        # Adding M2M table for field illustrations on 'Ensemble'
        m2m_table_name = db.shorten_name(u'libretto_ensemble_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ensemble', models.ForeignKey(orm[u'libretto.ensemble'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['ensemble_id', 'illustration_id'])

        # Adding M2M table for field documents on 'Lieu'
        m2m_table_name = db.shorten_name(u'libretto_lieu_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lieu', models.ForeignKey(orm[u'libretto.lieu'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lieu_id', 'document_id'])

        # Adding M2M table for field illustrations on 'Lieu'
        m2m_table_name = db.shorten_name(u'libretto_lieu_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lieu', models.ForeignKey(orm[u'libretto.lieu'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lieu_id', 'illustration_id'])

        # Adding M2M table for field illustrations on 'Partie'
        m2m_table_name = db.shorten_name(u'libretto_partie_illustrations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('partie', models.ForeignKey(orm[u'libretto.partie'], null=False)),
            ('illustration', models.ForeignKey(orm[u'libretto.illustration'], null=False))
        ))
        db.create_unique(m2m_table_name, ['partie_id', 'illustration_id'])

        # Adding M2M table for field documents on 'Partie'
        m2m_table_name = db.shorten_name(u'libretto_partie_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('partie', models.ForeignKey(orm[u'libretto.partie'], null=False)),
            ('document', models.ForeignKey(orm[u'libretto.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['partie_id', 'document_id'])
    ...
    models = {
        u'accounts.hierarchicuser': {
            ...
            'avatar2': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'libretto.source': {
            'Meta': {'ordering': "(u'date', u'titre', u'numero', u'page', u'type')", 'object_name': 'Source'},
            'cote': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'legende': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'lieu_conservation': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        u'libretto.sourceensemble': {
            ...
            'ensemble': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Ensemble']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Source']"})
        },
        u'libretto.sourceevenement': {
            ...
            'evenement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Evenement']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Source']"})
        },
        u'libretto.sourceindividu': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Individu']"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Source']"})
        },
        u'libretto.sourcelieu': {
            'Meta': {'unique_together': "((u'source', u'lieu'),)", 'object_name': 'SourceLieu', 'db_table': "u'libretto_source_lieux'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lieu': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Lieu']"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Source']"})
        },
        u'libretto.sourceoeuvre': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'oeuvre': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Oeuvre']"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Source']"})
        },
        u'libretto.sourcepartie': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'partie': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Partie']"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.Source']"})
        },
