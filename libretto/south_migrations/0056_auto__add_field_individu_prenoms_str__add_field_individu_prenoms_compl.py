...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individu.prenoms_str'
        db.add_column(u'libretto_individu', 'prenoms_str',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Individu.prenoms_complets'
        db.add_column(u'libretto_individu', 'prenoms_complets',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individu.prenoms_str'
        db.delete_column(u'libretto_individu', 'prenoms_str')

        # Deleting field 'Individu.prenoms_complets'
        db.delete_column(u'libretto_individu', 'prenoms_complets')
