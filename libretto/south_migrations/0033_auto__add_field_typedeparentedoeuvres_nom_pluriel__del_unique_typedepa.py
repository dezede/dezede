...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TypeDeParenteDIndividus', fields ['nom']
        db.delete_unique(u'libretto_typedeparentedindividus', ['nom'])

        # Removing unique constraint on 'TypeDeParenteDOeuvres', fields ['nom_relatif']
        db.delete_unique(u'libretto_typedeparentedoeuvres', ['nom_relatif'])

        # Removing unique constraint on 'TypeDeParenteDOeuvres', fields ['nom']
        db.delete_unique(u'libretto_typedeparentedoeuvres', ['nom'])

        # Adding field 'TypeDeParenteDOeuvres.nom_pluriel'
        db.add_column(u'libretto_typedeparentedoeuvres', 'nom_pluriel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=55, blank=True),
                      keep_default=False)


        # Changing field 'TypeDeParenteDIndividus.nom'
        db.alter_column(u'libretto_typedeparentedindividus', 'nom', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'TypeDeParenteDIndividus.nom_relatif'
        db.alter_column(u'libretto_typedeparentedindividus', 'nom_relatif', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'TypeDeParenteDIndividus.nom_relatif_pluriel'
        db.alter_column(u'libretto_typedeparentedindividus', 'nom_relatif_pluriel', self.gf('django.db.models.fields.CharField')(max_length=130))

    def backwards(self, orm):
        # Deleting field 'TypeDeParenteDOeuvres.nom_pluriel'
        db.delete_column(u'libretto_typedeparentedoeuvres', 'nom_pluriel')

        # Adding unique constraint on 'TypeDeParenteDOeuvres', fields ['nom']
        db.create_unique(u'libretto_typedeparentedoeuvres', ['nom'])

        # Adding unique constraint on 'TypeDeParenteDOeuvres', fields ['nom_relatif']
        db.create_unique(u'libretto_typedeparentedoeuvres', ['nom_relatif'])


        # Changing field 'TypeDeParenteDIndividus.nom'
        db.alter_column(u'libretto_typedeparentedindividus', 'nom', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
        # Adding unique constraint on 'TypeDeParenteDIndividus', fields ['nom']
        db.create_unique(u'libretto_typedeparentedindividus', ['nom'])


        # Changing field 'TypeDeParenteDIndividus.nom_relatif'
        db.alter_column(u'libretto_typedeparentedindividus', 'nom_relatif', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'TypeDeParenteDIndividus.nom_relatif_pluriel'
        db.alter_column(u'libretto_typedeparentedindividus', 'nom_relatif_pluriel', self.gf('django.db.models.fields.CharField')(max_length=55))
