...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fichier.extract'
        db.add_column(u'libretto_fichier', 'extract',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'extract_from', null=True, on_delete=models.SET_NULL, to=orm['libretto.Fichier'], blank=True, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fichier.extract'
        db.delete_column(u'libretto_fichier', 'extract_id')
