...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.delete_table('libretto_typedecaracteristiquedoeuvre')
        db.rename_table('libretto_polymorphictypedecaracteristiquedoeuvre',
                        'libretto_typedecaracteristiquedoeuvre')
