...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caracteristique.type'
        db.alter_column(u'libretto_caracteristique', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.TypeDeCaracteristique']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Caracteristique.type'
        raise RuntimeError("Cannot reverse this migration. 'Caracteristique.type' and its values cannot be restored.")
