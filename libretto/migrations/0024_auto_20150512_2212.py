...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='distribution2', verbose_name='\xe9l\xe9ment de programme', blank=True, to='libretto.ElementDeProgramme', null=True, on_delete=models.CASCADE),
