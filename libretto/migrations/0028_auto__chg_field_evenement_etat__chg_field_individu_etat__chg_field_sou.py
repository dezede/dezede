...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'libretto_evenement', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'Individu.etat'
        db.alter_column(u'libretto_individu', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'Source.etat'
        db.alter_column(u'libretto_source', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'Oeuvre.etat'
        db.alter_column(u'libretto_oeuvre', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'Profession.etat'
        db.alter_column(u'libretto_profession', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'ElementDeProgramme.etat'
        db.alter_column(u'libretto_elementdeprogramme', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'Lieu.etat'
        db.alter_column(u'libretto_lieu', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

        # Changing field 'Partie.etat'
        db.alter_column(u'libretto_partie', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Evenement.etat'
        db.alter_column(u'libretto_evenement', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'Individu.etat'
        db.alter_column(u'libretto_individu', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'Source.etat'
        db.alter_column(u'libretto_source', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'Oeuvre.etat'
        db.alter_column(u'libretto_oeuvre', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'Profession.etat'
        db.alter_column(u'libretto_profession', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'ElementDeProgramme.etat'
        db.alter_column(u'libretto_elementdeprogramme', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'Lieu.etat'
        db.alter_column(u'libretto_lieu', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))

        # Changing field 'Partie.etat'
        db.alter_column(u'libretto_partie', 'etat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Etat'], null=True, on_delete=models.PROTECT))
