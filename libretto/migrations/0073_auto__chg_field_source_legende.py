...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.legende'
        db.alter_column(u'libretto_source', 'legende', self.gf('django.db.models.fields.CharField')(max_length=600))

    def backwards(self, orm):

        # Changing field 'Source.legende'
        db.alter_column(u'libretto_source', 'legende', self.gf('django.db.models.fields.CharField')(max_length=100))
