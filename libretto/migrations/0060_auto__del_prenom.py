...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'libretto_prenom')


    def backwards(self, orm):
        # Adding model 'Prenom'
        db.create_table(u'libretto_prenom', (
            ('classement', self.gf('django.db.models.fields.SmallIntegerField')(default=1, db_index=True)),
            ('prenom', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('favori', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'prenom', null=True, to=orm['accounts.HierarchicUser'], on_delete=models.PROTECT, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'libretto', ['Prenom'])
