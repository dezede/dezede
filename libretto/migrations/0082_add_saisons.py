...
from libretto.api.models.utils import enlarged_create
from libretto.models import Saison, Ensemble

kwargs_list = [{'ensemble': Ensemble.objects.get(pk=206), 'debut': '2012-08-23', 'fin': '2013-07-22'},
               {'ensemble': Ensemble.objects.get(pk=206), 'debut': '2010-09-04', 'fin': '2011-07-08'},
               {'ensemble': Ensemble.objects.get(pk=206), 'debut': '2011-08-28', 'fin': '2012-07-13'},
               {'ensemble': Ensemble.objects.get(pk=204), 'debut': '2010-10-14', 'fin': '2011-06-24'},
               {'ensemble': Ensemble.objects.get(pk=204), 'debut': '2011-11-24', 'fin': '2012-07-07'},
               {'ensemble': Ensemble.objects.get(pk=204), 'debut': '2012-09-27', 'fin': '2013-06-07'},]
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        with transaction.atomic():
            for kwargs in kwargs_list:
                enlarged_create(Saison, kwargs)

    def backwards(self, orm):
        with transaction.atomic():
            for kwargs in kwargs_list:
                Saison.objects.get(**kwargs).delete()
    ...
    models = {
        ...
        u'libretto.source': {
            'Meta': {'ordering': "(u'type', u'date', u'titre', u'numero', u'page', u'lieu_conservation', u'cote')", 'object_name': 'Source'},
            'cote': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
