...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_table('libretto_caracteristiquedoeuvre')
        db.rename_table('libretto_polymorphiccaracteristiquedoeuvre',
    ...
    models = {
        ...
        u'libretto.caracteristique': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'caracteristiques'", 'on_delete': 'models.PROTECT', 'to': u"orm['libretto.TypeDeCaracteristique']"}),
