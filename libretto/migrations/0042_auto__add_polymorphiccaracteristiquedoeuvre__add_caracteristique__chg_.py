...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PolymorphicCaracteristiqueDOeuvre'
        db.create_table(u'libretto_polymorphiccaracteristiquedoeuvre', (
        ...
        db.send_create_signal(u'libretto', ['PolymorphicCaracteristiqueDOeuvre'])

        # Adding model 'Caracteristique'
        db.create_table(u'libretto_caracteristique', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_libretto.caracteristique_set', null=True, to=orm['contenttypes.ContentType'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'caracteristique', null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.TypeDeCaracteristique'], on_delete=models.PROTECT)),
        ...
        db.send_create_signal(u'libretto', ['Caracteristique'])


        # Changing field 'CaracteristiqueDOeuvre.type'
        db.alter_column(u'libretto_caracteristiquedoeuvre', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.TypeDeCaracteristique'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting model 'PolymorphicCaracteristiqueDOeuvre'
        db.delete_table(u'libretto_polymorphiccaracteristiquedoeuvre')

        # Deleting model 'Caracteristique'
        db.delete_table(u'libretto_caracteristique')


        # Changing field 'CaracteristiqueDOeuvre.type'
        db.alter_column(u'libretto_caracteristiquedoeuvre', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['libretto.TypeDeCaracteristiqueDOeuvre']))
    ...
    models = {
        ...
        u'libretto.caracteristique': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['libretto.TypeDeCaracteristique']", 'on_delete': 'models.PROTECT'}),
        ...
        u'libretto.polymorphiccaracteristiquedoeuvre': {
            'Meta': {'ordering': "(u'type', u'classement', u'valeur')", 'object_name': 'PolymorphicCaracteristiqueDOeuvre', '_ormbases': [u'libretto.Caracteristique']},
