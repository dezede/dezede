...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'libretto_partie', ['nom'])


    def backwards(self, orm):
        # Adding unique constraint on 'Partie', fields ['nom']
        db.create_unique(u'libretto_partie', ['nom'])
    ...
    models = {
        ...
        u'libretto.elementdedistribution': {
            'Meta': {'ordering': "(u'pupitre', u'profession', u'individus__nom')", 'object_name': 'ElementDeDistribution'},
