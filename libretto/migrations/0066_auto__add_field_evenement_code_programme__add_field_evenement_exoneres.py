...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evenement.code_programme'
        db.add_column(u'libretto_evenement', 'code_programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=55, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.exoneres'
        db.add_column(u'libretto_evenement', 'exoneres',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.payantes'
        db.add_column(u'libretto_evenement', 'payantes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.frequentation'
        db.add_column(u'libretto_evenement', 'frequentation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.scolaires'
        db.add_column(u'libretto_evenement', 'scolaires',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.jauge'
        db.add_column(u'libretto_evenement', 'jauge',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lieu.code_postal'
        db.add_column(u'libretto_lieu', 'code_postal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evenement.code_programme'
        db.delete_column(u'libretto_evenement', 'code_programme')

        # Deleting field 'Evenement.exoneres'
        db.delete_column(u'libretto_evenement', 'exoneres')

        # Deleting field 'Evenement.payantes'
        db.delete_column(u'libretto_evenement', 'payantes')

        # Deleting field 'Evenement.frequentation'
        db.delete_column(u'libretto_evenement', 'frequentation')

        # Deleting field 'Evenement.scolaires'
        db.delete_column(u'libretto_evenement', 'scolaires')

        # Deleting field 'Evenement.jauge'
        db.delete_column(u'libretto_evenement', 'jauge')

        # Deleting field 'Lieu.code_postal'
        db.delete_column(u'libretto_lieu', 'code_postal')
