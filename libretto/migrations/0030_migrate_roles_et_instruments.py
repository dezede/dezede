...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Role = orm['libretto.Role']
        Instrument = orm['libretto.Instrument']
        ContentType = orm['contenttypes.ContentType']
        role_ct = ContentType.objects.get(model='role')
        instrument_ct = ContentType.objects.get(model='instrument')
