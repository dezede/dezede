...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        content_types = ContentType.objects.filter(app_label='catalogue')
        content_types.update(app_label='libretto')

    def backwards(self, orm):
        ContentType = orm['contenttypes.ContentType']
        content_types = ContentType.objects.filter(app_label='libretto')
        content_types.update(app_label='catalogue')
