...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.delete_table('libretto_caracteristiquedelementdeprogramme')
        db.rename_table('libretto_polymorphiccaracteristiquedelementdeprogramme',
                        'libretto_caracteristiquedelementdeprogramme')
    ...
    models = {
        ...
        u'libretto.caracteristiquedelementdeprogramme': {
            'Meta': {'ordering': "(u'type', u'classement', u'valeur')", 'object_name': 'CaracteristiqueDElementDeProgramme', '_ormbases': [u'libretto.Caracteristique']},
