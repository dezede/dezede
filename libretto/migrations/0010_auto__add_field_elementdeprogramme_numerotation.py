...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'ElementDeProgramme.numerotation'
        db.delete_column('catalogue_elementdeprogramme', 'numerotation')
    ...
    models = {
        ...
        'catalogue.auteur': {
            ...
            'individu': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "u'auteurs'", 'to': "orm['catalogue.Individu']"}),
        ...
        'catalogue.caracteristiquedoeuvre': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [],
                     {'related_name': "u'caracteristiques_d_oeuvre'", 'to': "orm['catalogue.TypeDeCaracteristiqueDOeuvre']"}),
        ...
        'catalogue.elementdedistribution': {
            ...
            'individus': ('django.db.models.fields.related.ManyToManyField',
                          [], {'related_name': "u'elements_de_distribution'", 'symmetrical': 'False', 'to': "orm['catalogue.Individu']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'pupitre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'elements_de_distribution'", 'to': "orm['catalogue.Pupitre']"})
        },
        'catalogue.elementdeprogramme': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'personnels': ('django.db.models.fields.related.ManyToManyField'
                           '', [], {'blank': 'True', 'related_name': "u'elements_de_programme'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalogue.Personnel']"}),
        ...
        'catalogue.evenement': {
            ...
            'distribution': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'evenements'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalogue.ElementDeDistribution']"}),
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['catalogue.Document']", 'null': 'True', 'blank': 'True'}),
            'etat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Etat']", 'null': 'True', 'blank': 'True'}),
        ...
        'catalogue.parentedindividus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individus_cibles': ('django.db.models.fields.related'
                                 '.ManyToManyField', [], {'related_name':
                                                                                               "u'enfances_cibles'", 'symmetrical': 'False', 'to': "orm['catalogue.Individu']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'catalogue.source': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'illustrations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['catalogue.Illustration']", 'null': 'True', 'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length':
                                                                  '200'}),
            'notes': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
