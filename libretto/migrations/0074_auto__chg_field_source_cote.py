...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.cote'
        db.alter_column(u'libretto_source', 'cote', self.gf('django.db.models.fields.CharField')(max_length=35))

    def backwards(self, orm):

        # Changing field 'Source.cote'
        db.alter_column(u'libretto_source', 'cote', self.gf('django.db.models.fields.CharField')(max_length=30))
