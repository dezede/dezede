...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'libretto_ensemble', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'ensemble', null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser'])),
        ...
        # Adding M2M table for field caracteristiques on 'Evenement'
        m2m_table_name = db.shorten_name(u'libretto_evenement_caracteristiques')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evenement', models.ForeignKey(orm[u'libretto.evenement'], null=False)),
            ('caracteristiquedeprogramme', models.ForeignKey(orm[u'libretto.caracteristiquedeprogramme'], null=False))
        ))
        db.create_unique(m2m_table_name, ['evenement_id', 'caracteristiquedeprogramme_id'])

        # Adding M2M table for field ensembles on 'ElementDeDistribution'
        m2m_table_name = db.shorten_name(u'libretto_elementdedistribution_ensembles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('elementdedistribution', models.ForeignKey(orm[u'libretto.elementdedistribution'], null=False)),
            ('ensemble', models.ForeignKey(orm[u'libretto.ensemble'], null=False))
        ))
        db.create_unique(m2m_table_name, ['elementdedistribution_id', 'ensemble_id'])


    def backwards(self, orm):
        # Deleting model 'Membre'
        db.delete_table(u'libretto_membre')

        # Deleting model 'CaracteristiqueDEnsemble'
        db.delete_table(u'libretto_caracteristiquedensemble')

        # Deleting model 'Ensemble'
        db.delete_table(u'libretto_ensemble')
        ...
        # Removing M2M table for field caracteristiques on 'Evenement'
        db.delete_table(db.shorten_name(u'libretto_evenement_caracteristiques'))

        # Removing M2M table for field ensembles on 'ElementDeDistribution'
        db.delete_table(db.shorten_name(u'libretto_elementdedistribution_ensembles'))
