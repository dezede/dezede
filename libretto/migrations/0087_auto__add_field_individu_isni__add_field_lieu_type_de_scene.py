...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individu.isni'
        db.add_column(u'libretto_individu', 'isni',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Lieu.type_de_scene'
        db.add_column(u'libretto_lieu', 'type_de_scene',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individu.isni'
        db.delete_column(u'libretto_individu', 'isni')

        # Deleting field 'Lieu.type_de_scene'
        db.delete_column(u'libretto_lieu', 'type_de_scene')
