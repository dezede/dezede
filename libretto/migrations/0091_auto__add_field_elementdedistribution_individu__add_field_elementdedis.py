...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElementDeDistribution.individu'
        db.add_column(u'libretto_elementdedistribution', 'individu',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'+', null=True, to=orm['libretto.Individu']),
                      keep_default=False)

        # Adding field 'ElementDeDistribution.ensemble'
        db.add_column(u'libretto_elementdedistribution', 'ensemble',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'+', null=True, to=orm['libretto.Ensemble']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElementDeDistribution.individu'
        db.delete_column(u'libretto_elementdedistribution', 'individu_id')

        # Deleting field 'ElementDeDistribution.ensemble'
        db.delete_column(u'libretto_elementdedistribution', 'ensemble_id')
    ...
    models = {
        ...
        u'libretto.elementdedistribution': {
            ...
            'ensemble': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'+'", 'null': 'True', 'to': u"orm['libretto.Ensemble']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'+'", 'null': 'True', 'to': u"orm['libretto.Individu']"}),
