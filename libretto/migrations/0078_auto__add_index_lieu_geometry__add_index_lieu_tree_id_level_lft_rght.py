...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Lieu', fields ['geometry']
        db.create_index(u'libretto_lieu', ['geometry'])

        # Adding index on 'Lieu', fields [u'tree_id', u'level', u'lft', u'rght']
        db.create_index(u'libretto_lieu', [u'tree_id', u'level', u'lft', u'rght'])


    def backwards(self, orm):
        # Removing index on 'Lieu', fields [u'tree_id', u'level', u'lft', u'rght']
        db.delete_index(u'libretto_lieu', [u'tree_id', u'level', u'lft', u'rght'])

        # Removing index on 'Lieu', fields ['geometry']
        db.delete_index(u'libretto_lieu', ['geometry'])
