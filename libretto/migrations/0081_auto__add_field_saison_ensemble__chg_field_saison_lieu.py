...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Saison.ensemble'
        db.add_column(u'libretto_saison', 'ensemble',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'saisons', null=True, to=orm['libretto.Ensemble']),
                      keep_default=False)


        # Changing field 'Saison.lieu'
        db.alter_column(u'libretto_saison', 'lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Lieu']))

    def backwards(self, orm):
        # Deleting field 'Saison.ensemble'
        db.delete_column(u'libretto_saison', 'ensemble_id')


        # Changing field 'Saison.lieu'
        db.alter_column(u'libretto_saison', 'lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['libretto.Lieu']))
