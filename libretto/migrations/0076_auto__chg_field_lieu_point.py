...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lieu.point'
        db.alter_column(u'libretto_lieu', 'point', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True))

    def backwards(self, orm):

        # Changing field 'Lieu.point'
        db.alter_column(u'libretto_lieu', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))
    ...
    models = {
        ...
        u'libretto.lieu': {
            ...
            'point': ('django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'}),
