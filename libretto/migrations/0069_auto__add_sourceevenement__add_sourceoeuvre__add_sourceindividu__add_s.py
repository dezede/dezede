...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SourceOeuvre'
        db.create_table(u'libretto_source_oeuvres', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Source'])),
            ('oeuvre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Oeuvre'])),
        ))
        db.send_create_signal(u'libretto', ['SourceOeuvre'])

        # Adding model 'SourceIndividu'
        db.create_table(u'libretto_source_individus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Source'])),
            ('individu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Individu'])),
        ))
        db.send_create_signal(u'libretto', ['SourceIndividu'])

        # Adding model 'SourcePartie'
        db.create_table(u'libretto_source_parties', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Source'])),
            ('partie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Partie'])),
        ))
        db.send_create_signal(u'libretto', ['SourcePartie'])

        # Adding model 'Fichier'
        db.create_table(u'libretto_fichier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'fichier', null=True, on_delete=models.PROTECT, to=orm['accounts.HierarchicUser'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fichiers', to=orm['libretto.Source'])),
            ('fichier', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('folio', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('page', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
        ...
        db.send_create_signal(u'libretto', ['Fichier'])

        # Adding model 'SourceLieu'
        db.create_table(u'libretto_source_lieux', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Source'])),
            ('lieu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Lieu'])),
        ))
        db.send_create_signal(u'libretto', ['SourceLieu'])

        # Adding model 'SourceEnsemble'
        db.create_table(u'libretto_source_ensembles', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Source'])),
            ('ensemble', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['libretto.Ensemble'])),
        ))
        db.send_create_signal(u'libretto', ['SourceEnsemble'])

        db.rename_column(u'libretto_source', 'nom', 'titre')

        db.rename_column(u'libretto_source', 'contenu', 'transcription')

        # Adding field 'Source.legende'
        db.add_column(u'libretto_source', 'legende',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Source.folio'
        db.add_column(u'libretto_source', 'folio',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Source.lieu_conservation'
        db.add_column(u'libretto_source', 'lieu_conservation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Source.cote'
        db.add_column(u'libretto_source', 'cote',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Source.url'
        db.add_column(u'libretto_source', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Source.date_approx'
        db.add_column(u'libretto_source', u'date_approx',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)

        # Changing field 'Source.page'
        db.alter_column(u'libretto_source', 'page', self.gf('django.db.models.fields.CharField')(max_length=10))


        db.create_unique(u'libretto_source_oeuvres',
                         ['source_id', 'oeuvre_id'])
        db.create_unique(u'libretto_source_individus',
                         ['source_id', 'individu_id'])
        db.create_unique(u'libretto_source_parties',
                         ['source_id', 'partie_id'])
        db.create_unique(u'libretto_source_lieux', ['source_id', 'lieu_id'])
        db.create_unique(u'libretto_source_ensembles',
