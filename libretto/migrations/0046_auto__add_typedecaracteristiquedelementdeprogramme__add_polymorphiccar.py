...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeDeCaracteristiqueDElementDeProgramme'
        db.create_table(u'libretto_typedecaracteristiquedelementdeprogramme', (
        ...
        db.send_create_signal(u'libretto', ['TypeDeCaracteristiqueDElementDeProgramme'])

        # Adding model 'PolymorphicCaracteristiqueDElementDeProgramme'
        db.create_table(u'libretto_polymorphiccaracteristiquedelementdeprogramme', (
        ...
        db.send_create_signal(u'libretto', ['PolymorphicCaracteristiqueDElementDeProgramme'])


    def backwards(self, orm):
        # Deleting model 'TypeDeCaracteristiqueDElementDeProgramme'
        db.delete_table(u'libretto_typedecaracteristiquedelementdeprogramme')

        # Deleting model 'PolymorphicCaracteristiqueDElementDeProgramme'
        db.delete_table(u'libretto_polymorphiccaracteristiquedelementdeprogramme')
    ...
    models = {
        ...
        u'libretto.polymorphiccaracteristiquedelementdeprogramme': {
            'Meta': {'ordering': "(u'type', u'classement', u'valeur')", 'object_name': 'PolymorphicCaracteristiqueDElementDeProgramme', '_ormbases': [u'libretto.Caracteristique']},
            u'caracteristique_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['libretto.Caracteristique']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'libretto.prenom': {
        ...
        u'libretto.typedecaracteristiquedelementdeprogramme': {
            'Meta': {'ordering': "(u'classement',)", 'object_name': 'TypeDeCaracteristiqueDElementDeProgramme', '_ormbases': [u'libretto.TypeDeCaracteristique']},
