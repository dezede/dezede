...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'libretto_individu_prenoms'))


    def backwards(self, orm):
        # Adding M2M table for field prenoms on 'Individu'
        m2m_table_name = db.shorten_name(u'libretto_individu_prenoms')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('individu', models.ForeignKey(orm[u'libretto.individu'], null=False)),
            ('prenom', models.ForeignKey(orm[u'libretto.prenom'], null=False))
        ))
        db.create_unique(m2m_table_name, ['individu_id', 'prenom_id'])
