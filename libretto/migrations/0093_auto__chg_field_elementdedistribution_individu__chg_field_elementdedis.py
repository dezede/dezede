...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field individus on 'ElementDeDistribution'
        db.delete_table(db.shorten_name(u'libretto_elementdedistribution_individus'))


        # Changing field 'ElementDeDistribution.individu'
        db.alter_column(u'libretto_elementdedistribution', 'individu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Individu']))

        # Changing field 'ElementDeDistribution.ensemble'
        db.alter_column(u'libretto_elementdedistribution', 'ensemble_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['libretto.Ensemble']))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field individus on 'ElementDeDistribution'
        m2m_table_name = db.shorten_name(u'libretto_elementdedistribution_individus')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('elementdedistribution', models.ForeignKey(orm[u'libretto.elementdedistribution'], null=False)),
            ('individu', models.ForeignKey(orm[u'libretto.individu'], null=False))
        ))
        db.create_unique(m2m_table_name, ['elementdedistribution_id', 'individu_id'])


        # Changing field 'ElementDeDistribution.individu'
        db.alter_column(u'libretto_elementdedistribution', 'individu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Individu']))

        # Changing field 'ElementDeDistribution.ensemble'
        db.alter_column(u'libretto_elementdedistribution', 'ensemble_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['libretto.Ensemble']))
    ...
    models = {
        ...
        u'libretto.auteur': {
            'Meta': {'ordering': "(u'profession', u'individu__nom')", 'object_name': 'Auteur', 'index_together': "((u'content_type', u'object_id'),)"},
        ...
        u'libretto.elementdedistribution': {
            ...
            'ensemble': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['libretto.Ensemble']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['libretto.Individu']"}),
