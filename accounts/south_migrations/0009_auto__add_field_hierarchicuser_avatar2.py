...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HierarchicUser.avatar2'
        db.add_column(u'accounts_hierarchicuser', 'avatar2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HierarchicUser.avatar2'
        db.delete_column(u'accounts_hierarchicuser', 'avatar2')
