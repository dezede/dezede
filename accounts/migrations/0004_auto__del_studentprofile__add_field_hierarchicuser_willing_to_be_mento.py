...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HierarchicUser.willing_to_be_mentor'
        db.add_column(u'accounts_hierarchicuser', 'willing_to_be_mentor',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'accounts_studentprofile', (
            ('professor', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'students', to=orm['auth.User'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'student_profile', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'accounts', ['StudentProfile'])

        # Deleting field 'HierarchicUser.willing_to_be_mentor'
        db.delete_column(u'accounts_hierarchicuser', 'willing_to_be_mentor')
