...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Diapositive', fields ['position']
        db.delete_unique(u'dezede_diapositive', ['position'])


    def backwards(self, orm):
        # Adding unique constraint on 'Diapositive', fields ['position']
        db.create_unique(u'dezede_diapositive', ['position'])
